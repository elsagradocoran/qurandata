...
QuranData.Aya = [
  ...
  [4, 40, 'Dios no es injusto con nadie ni en el peso de la más ínfima partícula. Por el contrario, retribuye generosamente toda obra de bien, y concede de Su parte una recompensa magnánima.'],
  ...
  [4, 67, 'les habría concedido una magnífica recompensa,'],
  [4, 68, 'y los habría guiado por el sendero recto.'],
  ...
  [4, 70, 'Esa es la generosidad de Dios. Y Dios es el único que todo lo sabe.'],
  ...
  [4, 120, 'Les hará falsas promesas y les dará esperanzas; el demonio no hace sino engañar.'],
  [4, 121, 'Su morada será el Infierno del que no encontrarán escapatoria.'],
  ...
  [4, 138, 'Anuncia a los hipócritas que recibirán un castigo doloroso.'],
  ...
  [5, 10, 'Pero [en cambio] los que niegan la verdad y rechazan Mi palabra serán los habitantes del fuego del Infierno.'],
  ...
  [5, 36, 'Los que niegan la verdad, aunque tuvieran todo cuanto existe en la Tierra y aún el doble para ofrecerlo como rescate y salvarse del castigo del Día de la Resurrección, no se les aceptará, y recibirán un castigo doloroso.'],
  ...
  [5, 40, '¿Acaso no sabes que a Dios pertenece el reino de los cielos y de la Tierra? Castiga a quien quiere y perdona a quien quiere. Dios es sobre toda cosa Poderoso.'],
  ...
  [5, 73, 'Quienes dicen: "Dios es una de las tres personas de la trinidad", niegan la verdad, porque no hay más que una sola divinidad. Si no desisten de sus palabras, un castigo doloroso azotará a quienes se obstinan en negar la verdad.'],
  ...
  [5, 98, 'Sepan que Dios es severo en el castigo, pero también es Perdonador, Misericordioso.'],
  ...
  [5, 115, 'Respondió Dios: "La haré descender; pero si después alguno de ustedes reniega [de su fe], lo castigaré como no he castigado a nadie en el mundo".'],
  ...
  [5, 120, 'A Dios pertenece el reino de los cielos y de la tierra, y cuanto existe entre ambos. Él tiene poder sobre todas las cosas.'],
  ...
  [6, 15, 'Di: "Temo el castigo de un día terrible si desobedezco a mi Señor".'],
  ...
  [6, 21, '¿Acaso existe alguien más injusto que quien atribuye a Dios sus falsos inventos, o quien desmiente Su Palabra? Los injustos jamás prosperarán.'],
  ...
  [6, 49, 'Pero a quienes desmientan Mis signos, los alcanzará el castigo por su perversidad.'],
  ...
  [6, 78, 'Y cuando vio salir el Sol dijo: "¡Este es mi Señor, este es el más grande [de los astros]!" Pero cuando desapareció dijo: "¡Pueblo mío! Yo estoy libre de asociarle, como ustedes, divinidades a Dios.'],
  ...
  [6, 127, 'Ellos tendrán una morada de paz junto a su Señor, Quien es su Protector, como recompensa por sus obras.'],
  ...
  [6, 155, 'Este es un Libro bendito que he revelado para que lo sigan, quizás así se les tenga misericordia.'],
  ...
  [7, 5, 'Cuando los alcanzó Mi castigo dijeron: "Éramos de los que cometían injusticias".'],
  ...
  [7, 8, 'Ese día se pesarán las obras con la verdad. Aquellos cuyas [buenas] obras pesen más [en la balanza] serán los bienaventurados.'],
  ...
  [7, 23, 'Ellos dijeron [arrepentidos]: "¡Señor nuestro! Hemos sido injustos con nosotros mismos; si no nos perdonas y nos tienes misericordia, seremos de los perdidos".'],
  [7, 24, 'Dijo [Dios]: "¡Desciendan [del Paraíso]! Serán enemigos unos de otros. En la Tierra tendrán morada y deleite por un tiempo".'],
  [7, 25, 'Dijo [Dios]: "En ella vivirán y morirán, y de ella serán resucitados".'],
  ...
  [7, 36, 'Pero quienes desmientan Mis signos y tengan una actitud soberbia, esos serán la gente del Fuego, donde morarán por toda la eternidad.'],
  ...
  [7, 42, 'Pero quienes hayan creído y realizado obras de bien, y a nadie le exijo una carga mayor a la que puede soportar, serán la gente del Paraíso donde morarán por toda la eternidad. '],
  ...
  [7, 61, 'Dijo [Noé]: "¡Oh, pueblo mío! No hay en mí extravío alguno, sino que soy un Mensajero del Señor del universo.'],
  [7, 62, 'Les transmito el Mensaje de mi Señor y les aconsejo para su bien, puesto que sé acerca de Dios lo que ustedes ignoran".'],
  ...
  [7, 67, 'Dijo [Hud]: "¡Oh, pueblo mío! No estoy en ninguna insensatez, solo soy un Mensajero enviado por el Señor del universo,'],
  ...
  [7, 76, 'Los soberbios dijeron: "Nosotros rechazamos lo que ustedes creen".'],
  ...
  [7, 84, 'Envié sobre ellos una lluvia. Observa cómo es el final de los que cometen crímenes [morales].'],
  ...
  [7, 90, 'Los nobles de su pueblo que rechazaron la verdad dijeron: "Si siguen a Jetró serán de los perdedores".'],
  ...
  [7, 97, '¿Acaso la gente de esas ciudades se sentían seguros de que Mi ira no podría alcanzarlos por la noche, mientras dormían?'],
  ...
  [7, 99, '¿Acaso se sentían a salvo del plan de Dios? Solo se sienten a salvo del plan de Dios los que están perdidos.'],
  ...
  [7, 104, 'Dijo Moisés: "¡Oh, Faraón! Soy un Mensajero del Señor del universo.'],
  ...
  [7, 106, 'Dijo [el Faraón]: "Si has traído un milagro, muéstramelo si eres sincero".'],
  ...
  [7, 109, 'Dijo la nobleza del pueblo del Faraón: "Él es un hechicero experto.'],
  ...
  [7, 114, 'Dijo el Faraón: "¡Sí! Se los recompensará y serán de mis allegados".'],
  ...
  [7, 119, 'Y fueron vencidos [los hechiceros] quedando humillados.'],
  [7, 120, 'Pero los hechiceros se prosternaron.'],
  ...
  [7, 124, 'Haré que les amputen una mano y el pie del lado opuesto, luego los haré clavar sobre un madero".'],
  ...
  [7, 128, 'Moisés dijo a su pueblo: "Busquen la ayuda de Dios y sean pacientes [ante esta prueba]. La Tierra es de Dios, y la dará en herencia a quien quiera de Sus siervos. El buen fin es para los que tienen temor [de Dios]".'],
  ...
  [7, 140, 'Dijo: "¿Cómo podría admitir que ustedes adoren ídolos en vez de Dios, siendo que Él los distinguió entre sus contemporáneos?'],
  ...
  [7, 151, 'Dijo Moisés: "¡Oh, Señor mío! Perdona a mi hermano y a mí, y ten misericordia de nosotros. Tú eres el más Misericordioso".'],
  [7, 152, 'La ira de Dios azotará a aquellos que adoraron el becerro, y serán humillados en esta vida mundanal. Así es como castigo a quienes inventan mentiras.'],
  ...
  [7, 174, 'Así es como explico los signos para que recapaciten.'],
  ...
  [7, 178, 'A quien Dios guíe estará encaminado, pero a quien [Dios] extravíe estará perdido.'],
  ...
  [7, 186, 'A quien Dios extravía nadie lo podrá guiar. A éstos Dios los deja que actúen desorientados en su ceguera.'],
  ...
  [7, 196, 'Mi protector es Dios, Quien reveló el Libro. Él es Quien protege a los justos.'],
  [7, 197, 'Los que ustedes invocan en vez de Dios no pueden auxiliarlos ni auxiliarse a ellos mismos.'],
  ...
  [8, 8, 'para que así prevalezca la Verdad y se desvanezca la falsedad, aunque ello les disguste a los criminales.'],
  ...
  [8, 36, 'Los que se niegan a creer gastan su dinero para apartar a la gente del sendero de Dios. Seguirán gastando hasta que lo lamentarán, y finalmente serán vencidos. Los que se niegan a creer serán finalmente congregados en el Infierno.'],
  ...
  [8, 40, 'Pero si ellos se niegan [y prefieren seguir persiguiendo a los creyentes], sepan ustedes que Dios es su Protector. ¡Qué excelente Protector y qué excelente Defensor!'],
  ...
  [8, 53, 'Dios no quita a ningún pueblo las gracias con las que lo ha bendecido, a menos que este se pervierta. Dios todo lo oye, todo lo sabe.'],
  ...
  [8, 55, 'Las peores criaturas ante Dios son los incrédulos, pues se negaron a creer,'],
  ...
  [9, 10, 'No respetan pacto ni compromiso con los creyentes. Ellos son los transgresores.'],
  ...
  [9, 21, 'Su Señor les albricia [que serán recompensados] con Su misericordia, Su complacencia, y con jardines donde gozarán de delicias inagotables.'],
  [9, 22, 'Vivirán en ellos por toda la eternidad. Dios les tiene reservada una recompensa grandiosa.'],
  ...
  [9, 35, 'El Día del Juicio, lo que atesoraron se tornará incandescente por el fuego del Infierno, y sus frentes, sus costados y sus espaldas serán marcados con ello. [Se les dirá:] "Esto es lo que atesoraron, sufran ahora su castigo".'],
  ...
  [9, 78, '¿Acaso no saben que Dios conoce sus intenciones y sus conspiraciones? Dios conoce bien lo oculto.'],
  ...
  [9, 80, 'Es igual [¡oh, Mujámmad!] que pidas perdón por ellos o que no lo hagas. Aunque pidieras perdón por ellos setenta veces, Dios no los perdonaría, porque no creyeron en Dios ni en Su Mensajero, y Dios no guía a los perversos.'],
  ...
  [9, 86, 'Cuando es revelado un capítulo [del Corán] en el que se les ordena creer en Dios y combatir junto al Mensajero, los que están en condiciones de ir se excusan diciéndote: "Permítenos quedarnos con los eximidos".'],
  ...
  [9, 89, 'Dios tiene reservado para ellos jardines [en el Paraíso] por donde corren ríos, donde morarán por toda la eternidad. Ese es el triunfo grandioso.'],
  ...
  [9, 102, 'Otros, en cambio, reconocen sus pecados [y se arrepienten], pues realizaron obras malas que empañaron sus obras buenas. A estos Dios les aceptará su arrepentimiento, porque Dios es Absolvedor, Misericordioso.'],
  ...
  [9, 125, 'En cambio, a aquellos cuyos corazones están enfermos [de hipocresía], este [nuevo capítulo] les aumenta maldad a la maldad [espiritual] que ya tienen, y mueren negando la verdad.'],
  ...
  [10, 10, 'Allí invocarán: "¡Glorificado seas, oh, Señor!" Y el saludo entre ellos será: "¡Paz!" Y al finalizar sus súplicas dirán: "¡Todas las alabanzas pertenecen a Dios, Señor del universo!"'],
  ...
  [10, 34, 'Di: "¿Acaso alguno de sus ídolos puede originar una creación y luego reproducirla?" Diles: "Dios es Quien origina la creación y luego la reproduce. ¿Cómo pueden ser tan desviados [de adorar a otros]?"'],
  ...
  [10, 48, 'Y dijeron: "¿Cuándo se cumplirá esta amenaza, si es que dices la verdad?"'],
  ...
  [10, 56, 'Él da la vida y da la muerte, y ante Él han de comparecer.'],
  ...
  [10, 69, 'Di: "Quienes atribuyen a Dios sus propias invenciones jamás alcanzarán la felicidad".'],
  ...
  [10, 86, 'Y por Tu misericordia, sálvanos de la gente que se niega a creer".'],
  ...
  [11, 4, 'Ante Dios han de comparecer y Él es sobre toda cosa poderoso".'],
  ...
  [11, 11, 'No se comportan así quienes fueron pacientes [ante las adversidades] y obraron el bien [en los momentos de gracia]; éstos obtendrán el perdón y una gran recompensa.'],
  ...
  [11, 47, 'Dijo [Noé]: "¡Oh, Señor mío! Me refugio en Ti de cuestionarte algo sobre lo que no tengo conocimiento; si no me perdonas y Te apiadas de mí, me contaré entre los perdedores".'],
  ...
  [11, 53, 'Dijeron: "¡Oh, Hud! No nos has presentado ningún milagro como para que abandonemos nuestros ídolos solo porque tú lo dices. ¡No tenemos fe en ti!'],
  ...
  [11, 75, 'Abraham era indulgente, lleno de compasión y siempre pedía perdón.'],
  ...
  [11, 115, 'Sé paciente [ante las dificultades], porque Dios no dejará que se pierda la recompensa de los que hacen el bien.'],
  ...
  [12, 12, 'Deja que venga con nosotros mañana, se divertirá y jugará. Nosotros lo cuidaremos".'],
  ...
  [14, 14, 'los haré habitar la tierra después de ellos. Eso será para quienes teman [el día de] la comparecencia ante Mí y teman Mi advertencia".'],
  ...
  [14, 39, '¡Alabado sea Dios!, Quien me agració en la vejez con [mis hijos] Ismael e Isaac. Mi Señor escucha bien las súplicas de quienes Lo invocan.'],
  ...
  [16, 3, 'Dios creó los cielos y la Tierra con un fin justo y verdadero. Él está por encima de cuanto Le asocian.'],
  ...
  [16, 16, 'y también señales, y para que se orienten en sus viajes, [creó] las estrellas.'],
  [16, 17, '¿Es procedente comparar a Quien es capaz de crear con quien no puede crear nada? ¿Acaso no recapacitan?'],
  [16, 18, 'Si intentaran contar las gracias de Dios no podrían enumerarlas. Dios es Absolvedor, Misericordioso.'],
  [16, 19, 'Dios sabe lo que ocultan y lo que manifiestan.'],
  [16, 20, '[Los ídolos] a quienes ustedes invocan en lugar de Dios, no solo no pueden crear absolutamente nada, sino que ellos mismos son creados.'],
  ...
  [16, 34, 'Sufrirán las consecuencias de las malas acciones que cometieron y los azotará el castigo del cual se burlaban.'],
  ...
  [16, 39, '[Dios los resucitará] para demostrarles cuál era la Verdad sobre la que discrepaban y para que los incrédulos comprendan que estaban equivocados.'],
  ...
  [16, 42, 'Ellos fueron pacientes y se encomendaron plenamente a su Señor.'],
  ...
  [16, 50, '[Los ángeles] temen a su Señor que está por encima de ellos, y ejecutan todo cuanto se les ordena.'],
  [16, 51, 'Dios dice: "No adoren falsas divinidades. Yo soy la única divinidad, tengan temor devocional solo de Mí".'],
  ...
  [16, 60, 'Quienes no creen en la otra vida son el peor ejemplo [de ignorancia e incredulidad], y Dios es el más sublime ejemplo [de perfección absoluta]. Él es el Poderoso, el Sabio.'],
  ...
  [16, 65, 'Dios hace descender agua del cielo dando vida con ella a la tierra azotada por la sequía. En esto hay un signo para quienes recapacitan.'],
  ...
  [16, 82, 'Pero si se niegan a creer, sabe que a ti solo te incumbe transmitir [el Mensaje] con claridad.'],
  ...
  [16, 85, 'Cuando los injustos vean el castigo, no habrá atenuantes ni prórrogas.'],
  ...
  [16, 104, 'A quienes no crean en los signos de Dios, Dios no los guiará y recibirán un castigo doloroso.'],
  ...
  [16, 109, 'No hay duda de que en la otra vida ellos serán los perdedores.'],
  ...
  [16, 119, 'Con quienes hayan cometido un mal por ignorancia y luego se arrepientan y enmienden, tu Señor será Absolvedor, Misericordioso.'],
  ...
  [17, 20, 'A todos [en esta vida] se les concederá de los favores de tu Señor, a los unos y a los otros. Sus favores no le son vedados a nadie.'],
  [17, 21, 'Observa cómo he agraciado a unos sobre otros [con bienes materiales en este mundo], pero en la otra vida la distinción será mayor [entre los que creen y los que no creen].'],
  ...
  [17, 89, 'He expuesto a los seres humanos en este Corán toda clase de ejemplos. Pero la mayoría de las personas no creen y rechazan la Verdad.'],
  ...
  [17, 96, 'Diles: "Dios es suficiente testigo de mi veracidad entre ustedes y yo. Él está bien informado sobre Sus siervos y los observa".'],
  ...
  [18, 35, 'Luego ingresó en su viñedo lleno de soberbia e incredulidad y exclamó: "No creo que este viñedo perezca jamás,'],
  ...
  [19, 19, 'Le dijo: "Soy un enviado de tu Señor para agraciarte con un hijo puro".'],
  [19, 20, 'Ella dijo: "¿Cómo voy a tener un hijo si no me ha tocado ningún hombre ni he fornicado?"'],
  ...
  [19, 43, '¡Oh, padre mío! Se me ha revelado un conocimiento que tú no tienes. Sígueme, y te guiaré por el sendero recto.'],
  [19, 44, '¡Oh, padre mío! No adores al demonio, porque el demonio fue desobediente con el Compasivo.'],
  ...
  [19, 63, 'Ése es el Paraíso que haremos heredar a quienes de Mis siervos hayan sido piadosos.'],
  ...
  [19, 78, '¿Acaso tiene conocimiento de lo oculto o tiene un pacto con el Compasivo?'],
  ...
  [19, 92, 'No es propio [de la grandiosidad] del Compasivo tener un hijo.'],
  [19, 93, 'Todos los que habitan en los cielos y en la Tierra se presentarán sumisos ante el Compasivo.'],
  [19, 94, 'Los ha enumerado y contado perfectamente.'],
  ...
  [20, 11, 'Cuando llegó a él, una voz lo llamó: "¡Oh, Moisés!'],
  ...
  [20, 20, 'Lo arrojó, y este se convirtió en una serpiente que reptaba.'],
  ...
  [20, 23, 'Te he mostrado algunos de Mis mayores milagros.'],
  [20, 24, 'Ve ante el Faraón, pues se ha extralimitado".'],
  [20, 25, 'Dijo [Moisés]: "¡Oh, Señor mío! Abre mi corazón [y dame valor],'],
  ...
  [20, 33, 'para que Te glorifiquemos'],
  ...
  [20, 56, 'Le mostré [al Faraón] todos Mis milagros, pero los desmintió y se rehusó a creer.'],
  [20, 57, 'Dijo [el Faraón]: "¡Oh, Moisés! ¿Acaso viniste a expulsarnos de nuestra tierra con tu hechicería?'],
  ...
  [20, 68, 'pero le dije: "No tengas temor, porque tú serás el vencedor.'],
  ...
  [20, 75, 'En cambio, quien se presente ante su Señor creyendo en Él y habiendo obrado rectamente, obtendrá los más altos grados [en el Paraíso].'],
  ...
  [20, 95, 'Dijo [Moisés]: "Y tú Samaritano, ¿qué has hecho?"'],
  ...
  [20, 120, 'Pero el demonio lo sedujo diciéndole: "¡Oh, Adán! ¿Quieres que te indique el árbol de la inmortalidad y el poder eterno?"'],
  ...
  [20, 127, 'Así voy a retribuir a quienes se extralimitaron y no creyeron en los signos de su Señor. Pero el castigo de la otra vida será aún más severo y duradero.'],
  ...
  [21, 4, 'Diles [¡oh, Mujámmad!]: "Mi Señor bien sabe todo lo que se dice en el cielo y en la Tierra. Él todo lo oye, todo lo sabe".'],
  ...
  [21, 16, 'No creé el cielo y la Tierra y todo cuanto existe entre ellos solo como un juego.'],
  ...
  [21, 21, '¿Acaso las divinidades que adoran en la Tierra tienen poder para resucitar a los muertos?'],
  ...
  [21, 27, 'No dan prioridad a sus palabras sobre la Palabra de Dios, y cumplen con lo que Él manda.'],
  ...
  [21, 29, 'Si uno de ellos dijera: "Yo soy un dios junto a Él", lo condenaría al Infierno, porque así castigo a los injustos.'],
  ...
  [21, 38, 'Dicen: "¿Cuándo se cumplirá tu advertencia? Si es verdad lo que dices".'],
  [21, 39, 'Si supieran los que se niegan a creer, que llegará un momento en que no podrán impedir que el fuego queme sus rostros y sus espaldas, y no serán socorridos.'],
  ...
  [21, 49, 'a los que tienen temor a su Señor en privado, y sienten temor de la Hora [del Juicio].'],
  ...
  [21, 52, 'Cuando dijo a su padre y a su pueblo: "¿Qué son estas estatuas a las que dedican su adoración?"'],
  [21, 53, 'Respondieron: "Vimos que nuestros padres las adoraban".'],
  [21, 54, 'Dijo: "Ustedes y sus padres están en un error evidente".'],
  [21, 55, 'Dijeron: "¿Nos hablas en serio o estás bromeando?"'],
  [21, 56, 'Dijo: "Su Señor es el Señor de los cielos y de la Tierra, el Creador de ambos, y yo doy testimonio de ello.'],
  ...
  [21, 60, 'Alguien dijo: "Oímos a un joven, llamado Abraham, hablar [mal] de ellos".'],
  [21, 61, 'Dijeron: "Tráiganlo a la vista de la gente, para que puedan atestiguar [contra él]".'],
  [21, 62, 'Le dijeron: "¡Oh, Abraham! ¿Fuiste tú quien destruyó nuestros dioses?"'],
  ...
  [21, 65, 'Pero luego volvieron a su estado anterior [y le dijeron]: "Tú bien sabes que no pueden hablar".'],
  [21, 66, 'Dijo [Abraham]: "¿Acaso adoran en vez de Dios lo que no puede beneficiarlos ni perjudicarlos [en lo más mínimo]?'],
  [21, 67, '¡Uf, qué perdidos están ustedes y lo que adoran en vez de Dios! ¿Es que no van a reflexionar?"'],
  ...
  [21, 70, 'Pretendieron deshacerse de él, pero hice que fueran ellos los perdedores.'],
  ...
  [21, 73, 'y líderes ejemplares para que guiasen [a la gente] siguiendo Mi voluntad. Y les inspiré realizar buenas obras, practicar la oración prescrita y pagar el zakat. Fueron devotos en la adoración.'],
  ...
  [21, 75, 'Lo ingresé en Mi misericordia, porque era uno de los justos.'],
  [21, 76, 'Cuando antes [de Lot] Noé Me invocó, le respondí [su súplica], salvándolo junto a su familia de la gran calamidad.'],
  [21, 77, 'Lo protegí del pueblo que rechazó Mis signos, era un pueblo perverso, y por eso hice que todos se ahogaran.'],
  ...
  [21, 89, 'Cuando [el Profeta] Zacarías rogó a su Señor: "¡Oh, Señor mío! No me dejes solo [sin hijos]. Tú eres Quien concede descendencia".'],
  ...
  [21, 93, 'Pero luego [las generaciones que vinieron después] se dividieron, aunque todos regresarán ante Mí.'],
  [21, 94, 'Quien sea creyente y realice obras buenas sepa que no habrá ingratitud para su esfuerzo. Todo lo tengo registrado.'],
  [21, 95, 'Es imposible que [los habitantes de] una ciudad que haya destruido fueran a arrepentirse [ni podrán volver a este mundo].'],
  ...
  [21, 108, 'Diles: "Me ha sido revelado que Dios es un Dios único. ¿Acaso no van a ser musulmanes?'],
  ...
  [21, 110, 'Él bien sabe tanto lo que dicen abiertamente como lo que dicen en secreto.'],
  ...
  [22, 3, 'Hay gente que discute acerca de Dios sin conocimiento, y siguen a todo demonio rebelde.'],
  ...
  [22, 8, 'Hay gente que discute acerca de Dios sin conocimiento, sin guía ni Libro que los ilumine.'],
  ...
  [22, 12, 'Ellos invocan en lugar de Dios aquello que no puede perjudicarlos ni beneficiarlos. Están en un error profundo.'],
  [22, 13, 'Adoran aquello cuyo perjuicio es más patente que su supuesto beneficio. ¡Qué pésimo protector y compañero!'],
  [22, 14, 'Dios introducirá a los que crean y obren rectamente en jardines por donde corren ríos. Dios hace lo que quiere.'],
  ...
  [22, 16, 'Así [como en las revelaciones anteriores] he revelado versículos claros, porque Dios guía a quien quiere.'],
  ...
  [22, 56, 'Ese día la soberanía solo Le pertenecerá a Dios, que juzgará entre ellos. Sepan que los que hayan creído y hecho obras de bien estarán en los Jardines de las Delicias,'],
  ...
  [22, 59, 'Los introducirá en un Paraíso en el que estarán complacidos. Dios es Conocedor, Tolerante.'],
  ...
  [22, 61, 'Dios hace que la noche suceda al día y el día a la noche. Dios todo lo oye, todo lo ve.'],
  ...
  [22, 64, 'A Él pertenece cuanto hay en los cielos y en la Tierra. Dios es el Opulento, el Loable.'],
  ...
  [22, 68, 'Pero si te desmienten, diles: "Dios bien sabe lo que hacen".'],
  [22, 69, 'Dios juzgará entre ustedes el Día del Juicio sobre lo que solían discrepar.'],
  ...
  [22, 74, 'No valoran ni enaltecen a Dios como Se merece. Dios es Fuerte, Poderoso.'],
  [22, 75, 'Dios selecciona a algunos ángeles como Mensajeros y selecciona algunas personas como Mensajeros. Dios todo lo oye, todo lo ve,'],
  ...
  [23, 21, 'En los ganados hay una lección: Doy a ustedes de beber de lo que hay en sus ubres, obtienen de ellos muchos beneficios y también se alimentan;'],
  [23, 22, 'usan a los animales y a los barcos como transporte.'],
  [23, 23, 'Envié a Noé a su pueblo y les dijo: "¡Oh, pueblo mío! Adoren solamente a Dios, pues no existe otra divinidad salvo Él. ¿Acaso no van a tener temor de Él?"'],
  ...
  [23, 26, 'Dijo Noé: "¡Oh, Señor mío! Socórreme, porque ellos me desmienten".'],
  ...
  [23, 28, 'Cuando tú y quienes estén contigo se encuentren en el arca, di: ¡Alabado sea Dios, Quien nos salvó de un pueblo de injustos!"'],
  ...
  [23, 34, 'Si obedecen a un ser humano como ustedes, serán unos perdedores.'],
  ...
  [23, 38, 'Él es solo un ser humano que ha inventado una gran mentira acerca de Dios, y no le vamos a creer".'],
  [23, 39, 'Dijo [el Profeta]: "¡Señor mío! Socórreme, pues me han desmentido".'],
  [23, 40, 'Dijo [Dios]: "Dentro de poco se arrepentirán".'],
  ...
  [23, 42, 'Luego hice surgir nuevas generaciones.'],
  ...
  [23, 48, 'Los desmintieron, y como consecuencia fueron destruidos.'],
  ...
  [23, 62, 'No exijo a nadie por encima de sus posibilidades. [Sepan que] tengo un Libro que dice la verdad, y nadie será tratado injustamente.'],
  ...
  [23, 70, 'Afirmaron que era un demente, pero él se presentó con la Verdad, aunque a la mayoría de ellos les disguste la verdad.'],
  ...
  [23, 78, 'Él es Quien los agració con el oído, la vista y el intelecto, pero poco se lo agradecen.'],
  [23, 79, 'Él es Quien los diseminó por la Tierra, y ante Él serán reunidos.'],
  [23, 80, 'Él es Quien da la vida y da la muerte, y Él decretó la alternancia de la noche y el día. ¿Es que no razonan?'],
  ...
  [23, 84, 'Pregúntales [¡oh, Mujámmad!]: "Si saben, ¿a quién pertenece la Tierra y todo lo que existe sobre ella?"'],
  ...
  [23, 90, 'Aunque les envié la verdad, ellos la desmienten.'],
  ...
  [23, 95, '[¡Oh, Mujámmad!] Tengo poder para hacerte ver el castigo que les he destinado.'],
  [23, 96, 'Si eres maltratado, responde con una buena actitud [sabiendo disculpar]. Yo bien sé lo que [Me] atribuyen.'],
  [23, 97, 'Di: "¡Oh, Señor mío! Me refugio en Ti de los susurros de los demonios,'],
  ...
  [23, 102, '[Ese día] aquellos cuyas buenas obras pesen más en la balanza serán los bienaventurados.'],
  ...
  [23, 105, '[Se les dirá:] "¿Acaso no se les recitaron Mis versículos y los desmentían?"'],
  [23, 106, 'Dirán: "¡Oh, Señor nuestro! Estábamos dominados por nuestras pasiones, éramos gente extraviada.'],
  ...
  [23, 118, 'Di [¡oh, Mujámmad!, enseñando a los creyentes]: "¡Oh, Señor mío! Perdona y ten misericordia. Tú eres el mejor de los misericordiosos".'],
  ...
  [24, 18, 'Dios les hace claros sus Signos. Dios lo sabe todo, es Sabio.'],
  ...
  [24, 20, 'Si no fuera por la gracia y la misericordia de Dios sobre ustedes, y porque Él es Compasivo y Misericordioso [rápido descendería el castigo por sus pecados]. '],
  ...
  [24, 42, 'A Dios pertenece el reino de los cielos y de la Tierra, y ante Él compareceréis.'],
  ...
  [24, 44, 'Dios hace que la noche y el día se sucedan. En esto hay un motivo de reflexión para los que tienen ojos [y quieren ver].'],
  ...
  [24, 46, 'He revelado [en este Corán] signos evidentes. Dios guía a quien Él quiere hacia el camino recto.'],
  ...
  [24, 50, '¿Es que sus corazones están enfermos [de tanta hipocresía], o dudan [acerca de Mujámmad], o acaso temen que Dios y Su Mensajero los opriman? Ellos son los injustos.'],
  ...
  [24, 56, 'Cumplan con la oración prescrita, paguen el zakat, y obedezcan al Mensajero, que así obtendrán la misericordia.'],
  ...
  [25, 3, 'Pero [los que se niegan a creer] adoran en vez de Dios a ídolos que no pueden crear nada, pues ellos mismos han sido creados, ni siquiera tienen el poder de apartar de sí mismos un perjuicio ni de atraer hacia sí mismos un beneficio. Tampoco tienen poder sobre la muerte, la vida ni la resurrección.'],
  ...
  [25, 52, 'No obedezcas a los que se niegan a creer, y lucha contra ellos esforzadamente, exhortándolos con el Corán.'],
  ...
  [25, 55, 'Sin embargo [los idólatras] adoran, en lugar de Dios, lo que no tiene poder para causarles beneficio ni perjuicio alguno. El que se niega a creer, da la espalda a su Señor.'],
  [25, 56, 'Te he enviado [¡oh, Mujámmad!] para que albricies [a los piadosos con el Paraíso] y adviertas [del Infierno a los que se niegan a creer].'],
  [25, 57, 'Diles: "No les pido ninguna remuneración a cambio [de enseñarles el Mensaje]. Quien quiera, que tome un camino hacia su Señor".'],
  ...
  [25, 76, 'Allí vivirán por toda la eternidad. ¡Qué hermosa morada y lugar de permanencia!'],
  ...
  [26, 9, 'Tu Señor es Poderoso, Misericordioso.'],
  ...
  [26, 26, 'Agregó [Moisés]: "Es su Señor y el Señor de sus ancestros".'],
  ...
  [26, 37, 'para que te traigan a todo hechicero experto".'],
  ...
  [26, 70, 'cuando dijo a su padre y a su pueblo: "¿Qué adoran?"'],
  ...
  [26, 74, 'Respondieron: "No, pero es lo que adoraban nuestros padres [y nosotros simplemente los imitamos]".'],
  ...
  [26, 79, 'Él me da de comer y de beber.'],
  ...
  [26, 95, 'y también los secuaces del demonio, todos juntos.'],
  [26, 96, 'Dirán, mientras disputan:'],
  [26, 97, '"[Juramos] por Dios que estábamos en un error evidente,'],
  [26, 98, 'pues equiparábamos a los ídolos con el Señor del Universo [al adorarlos].'],
  [26, 99, 'Pero fueron los pecadores los que nos desviaron.'],
  ...
  [26, 103, 'En esto hay un signo, pero la mayoría de ellos no eran creyentes.'],
  [26, 104, 'Tu Señor es el Poderoso, el Misericordioso.'],
  [26, 105, 'El pueblo de Noé desmintió a los Mensajeros.'],
  [26, 106, 'Su hermano Noé les dijo: "Tengan temor de Dios,'],
  [26, 107, 'soy para ustedes un Mensajero leal,'],
  ...
  [26, 131, 'Tengan temor de Dios y síganme.'],
  ...
  [26, 142, 'Su hermano Sálih les dijo: "Tengan temor de Dios,'],
  ...
  [26, 150, 'Tengan temor de Dios y síganme.'],
  [26, 151, 'Y no obedezcan las órdenes de los que se extralimitan,'],
  ...
  [26, 159, 'Tu Señor es el Poderoso, el Misericordioso.'],
  [26, 160, 'El pueblo de Lot desmintió a los Mensajeros.'],
  [26, 161, 'Su hermano Lot les dijo: "Tengan temor de Dios,'],
  [26, 162, 'yo soy para ustedes un Mensajero leal.'],
  [26, 163, 'Tengan temor de Dios y síganme.'],
  ...
  [26, 167, 'Dijeron: "¡Oh, Lot! Si no dejas de recriminarnos te expulsaremos".'],
  ...
  [26, 175, 'Tu Señor es el Poderoso, el Misericordioso.'],
  [26, 176, 'El pueblo de Jetró desmintió a los Mensajeros.'],
  [26, 177, 'Jetró les dijo: "Tengan temor de Dios,'],
  [26, 178, 'yo soy para ustedes un Mensajero leal.'],
  [26, 179, 'Tengan temor de Dios y síganme.'],
  ...
  [26, 185, 'Le respondieron: "Tú estás hechizado,'],
  [26, 186, 'y eres un ser humano igual que nosotros, al que consideramos un mentiroso.'],
  [26, 187, 'Te desafiamos a que hagas caer sobre nosotros un pedazo de cielo, si es que dices la verdad".'],
  [26, 188, 'Dijo [Jetró]: "Mi Señor conoce mejor que nadie lo que hacen".'],
  [26, 189, 'Pero lo desmintieron, y por ello los azotó el castigo el día de la sombra. Fue el castigo de un día terrible.'],
  [26, 190, 'En ello hay un signo, pero la mayoría de ellos no eran creyentes.'],
  [26, 191, 'Tu Señor es el Poderoso, el Misericordioso.'],
  [26, 192, 'Este [Corán] es una revelación del Señor del Universo.'],
  [26, 193, 'Descendió con él el Espíritu Leal [el ángel Gabriel],'],
  [26, 194, 'y lo grabó en tu corazón [¡oh, Mujámmad!] para que seas uno de los que advierten [a su pueblo].'],
  [26, 195, 'Es una revelación en lengua árabe pura,'],
  [26, 196, 'que ya estaba mencionada en las primeras Escrituras.'],
  ...
  [26, 213, 'Así que no invoquen a nada ni nadie junto a Dios, porque se autocondenarían al castigo.'],
  ...
  [26, 220, 'Él todo lo oye, todo lo sabe.'],
  ...
  [27, 27, 'Dijo [Salomón a la abubilla]: "Veremos si has dicho la verdad o eres de los que mienten.'],
  ...
  [27, 54, '[Recuerda al Profeta] Lot, cuando le dijo a su pueblo: "¿Cometen esa inmoralidad en público?"'],
  [27, 55, '¿Buscan hombres para satisfacer su deseo en lugar de satisfacerlo con una mujer? Son un pueblo ignorante.'],
  ...
  [27, 57, 'Salvé a Lot y a su familia, excepto a su mujer, pues en el decreto era de las condenadas.'],
  [27, 58, 'Hice que cayera sobre ellos una lluvia [de piedras]. ¡Qué lluvia más aterradora fue la que les envié!'],
  ...
  [27, 68, 'Eso ya se nos había prometido anteriormente, a nosotros y a nuestros padres. No es más que una fábula de los ancestros".'],
  [27, 69, 'Di: "Viajen por el mundo y observen cuál fue el final de los que han hecho el mal".'],
  ...
  [27, 73, 'Tu Señor concede Sus gracias a la gente, pero la mayoría no agradece.'],
  [27, 74, 'Tu Señor conoce lo que esconden sus corazones y lo que manifiestan.'],
  ...
  [27, 76, 'El Corán les relata a los Hijos de Israel [la respuesta] a gran parte de los asuntos sobre los que discrepaban.'],
  [27, 77, '[El Corán] es guía y misericordia para los creyentes.'],
  [27, 78, 'Tu Señor juzgará entre ellos con justicia. Él es el Poderoso, el que todo lo sabe.'],
  ...
  [27, 85, 'Luego los azotará el castigo que había sido prometido por haber cometido injusticias, y no podrán decir una sola palabra [para excusarse].'],
  ...
  [28, 10, 'La madre de Moisés sintió un vacío en su corazón y estuvo a punto de revelar la verdad, de no haber sido porque afiancé su corazón para que fuera una verdadera creyente.'],
  ...
  [28, 28, 'Dijo [Moisés]: "Eso es [un acuerdo] entre tú y yo. Cualquiera que sea el plazo que cumpla no será injusto conmigo, y Dios es testigo de lo que decimos".'],
  ...
  [28, 39, 'El Faraón y sus huestes tiranizaron el país violando todos los derechos, pensando que no iban a tener que comparecer ante Mí.'],
  ...
  [28, 41, 'Hice que ellos [en esta vida] fueran líderes, pero conducían [a la gente al] Infierno. El Día de la Resurrección no serán socorridos.'],
  ...
  [28, 53, 'Cuando se les recita [el Corán] dicen: "Creemos en él; es la Verdad que proviene de nuestro Señor. Antes de escucharlo ya éramos musulmanes [sometidos a Dios]".'],
  ...
  [28, 63, 'Dirán los [‘socios’] sentenciados [al Infierno]: "¡Señor nuestro! Éstos son los que desviamos. Los desviamos porque nosotros estábamos desviados. No somos responsables por sus actos, no era a nosotros a quienes adoraban".'],
  ...
  [28, 67, 'Pero quien se haya arrepentido, haya creído y hecho obras de bien, se contará entre quienes tendrán éxito.'],
  ...
  [28, 69, 'Tu Señor conoce lo que ocultan y lo que manifiestan sus corazones.'],
  [28, 70, 'Él es Al-lah, no hay más divinidad que Él. A Dios pertenecen las alabanzas en esta vida y en la otra. Suyo es el juicio, y ante Él comparecerán [el Día del Juicio].'],
  ...
  [28, 74, 'El día que [Dios] los convoque y les pregunte: "¿Dónde están los ‘socios’ que Me atribuían?"'],
  ...
  [28, 84, '[El Día del Juicio Final,] quien se presente habiendo realizado obras buenas será recompensado más de lo merecido por ellas, pero quien se presente habiendo realizado obras malas solo será retribuido por lo que hizo.'],
  ...
  [29, 9, 'A quienes hayan creído y hecho obras de bien los introduciré [al Paraíso] junto a los que obran con justicia.'],
  ...
  [29, 11, 'Dios hará evidente quiénes son los que creen y quiénes son los hipócritas.'],
  ...
  [29, 20, 'Diles [a quienes niegan la Resurrección]: "Viajen por el mundo y observen cómo [Dios] originó la creación. Luego, Dios la hará surgir nuevamente [el Día de la Resurrección]. Dios es sobre toda cosa Poderoso.'],
  [29, 21, 'Castiga a quien Él quiere y se apiada de quien Él quiere. Ante Él serán retornados.'],
  ...
  [29, 29, '¿Tienen relaciones homosexuales con hombres, asaltan a los viajeros y cometen toda clase de actos reprobables en sus reuniones?" Pero la respuesta de su pueblo fue: "Envíanos el castigo de Dios, si es que dices la verdad".'],
  [29, 30, 'Dijo [Lot]: "¡Señor mío! Sálvame de este pueblo corrupto".'],
  [29, 31, 'Cuando Mis [ángeles] emisarios se presentaron ante Abraham para albriciarle [el nacimiento de su hijo], dijeron: "Destruiremos a la población de esa ciudad, porque su gente comete injusticias".'],
  ...
  [29, 42, 'Dios conoce lo que ellos invocan en lugar de Él, porque Él es el Poderoso, el Sabio.'],
  [29, 43, 'Estos son ejemplos que doy a la gente, pero solo los comprenden quienes reflexionan.'],
  [29, 44, 'Dios creó los cielos y la Tierra con un fin justo y verdadero. En ello hay un signo para los creyentes.'],
  ...
  [29, 68, '¿Quién puede ser más injusto que aquel que inventa mentiras acerca de Dios o desmiente la Verdad cuando le llega? ¿Acaso no es el Infierno el destino de los que se niegan a creer [cuando la verdad se les hace evidente]?'],
  ...
  [30, 11, 'Dios origina la creación y luego la reproduce, y ante Él regresarán.'],
  ...
  [30, 14, 'El día que llegue la Hora, ese día se dividirán [en dos grupos]:'],
  [30, 15, 'Quienes hayan creído y obrado rectamente morarán en los jardines del deleite.'],
  [30, 16, 'Pero quienes no hayan creído y hayan desmentido Mis signos y la existencia de la otra vida, sufrirán eternamente un tormento.'],
  ...
  [30, 23, 'Entre Sus signos está [haber creado] la noche para que descansen y el día para que procuren Su favor. En esto hay signos para un pueblo que escucha.'],
  ...
  [30, 30, 'Conságrate al monoteísmo, que es la inclinación natural con la que Dios creó a la gente. La religión de Dios es inalterable y esta es la forma de adoración verdadera, pero la mayoría de la gente lo ignora.'],
  ...
  [30, 33, 'Cuando una desgracia azota a la gente, invocan a su Señor arrepentidos. Pero cuando los agracia con Su misericordia, un grupo de ellos atribuye divinidades a su Señor [en la adoración]'],
  ...
  [30, 37, '¿Acaso no ven que Dios concede abundante sustento a Quien quiere y lo restringe [a quien quiere]? En eso hay signos para quienes creen.'],
  ...
  [30, 42, 'Diles: "Viajen por el mundo y observen cuál fue el final de los pueblos antiguos. La mayoría Le asociaban ídolos a Dios [en la adoración]".'],
  ...
  [30, 45, 'Dios recompensará con Su gracia a quienes hayan creído y obrado rectamente. Él no ama a los que se niegan a creer [cuando les llega el Mensaje].'],
  ...
  [30, 58, 'He citado en este Corán todo tipo de ejemplos. Pero aún si te hubieras presentado ante ellos con un milagro, hubieran dicho: "Solo son unos farsantes".'],
  [30, 59, 'Así es como Dios sella los corazones de los que no quieren conocer [la verdad].'],
  ...
  [31, 1, 'Álif. Lam. Mim.'],
  [31, 2, 'Estos son los versículos de un Libro sabio,'],
  ...
  [31, 12, 'Agracié a Luqmán con la sabiduría [y le dije]: "Sé agradecido con Dios, pues quien agradece lo hace en beneficio propio, mientras que el ingrato debe saber que Dios no precisa del agradecimiento [de las personas] y es digno de toda alabanza".'],
  ...
  [31, 17, '¡Oh, hijito! Haz la oración, ordena el bien y condena el mal, y sé paciente ante la adversidad, porque esas son cualidades de la entereza.'],
  ...
  [31, 21, '[A estos] cuando se les dice: "Sigan lo que Dios ha revelado", responden: "Nosotros seguimos la tradición de nuestros padres". ¿[La seguirían] Incluso si el demonio los arrastrara al castigo del Infierno?'],
  ...
  [31, 23, 'No sientas pena por la incredulidad de los que se niegan a creer, ellos comparecerán ante Mí y les informaré lo que cometieron. Dios conoce lo que esconden los corazones.'],
  [31, 24, 'Los dejaré que gocen un tiempo breve y luego los llevaré a un castigo riguroso.'],
  ...
  [31, 26, 'A Dios pertenece cuanto existe en los cielos y en la Tierra, y Él es el Opulento, el digno de alabanza.'],
  ...
  [31, 31, '¿Acaso no ven que los barcos navegan en el mar por la gracia de Dios? Es una muestra de Sus signos. En ello hay señales para quien es perseverante y agradecido.'],
  ...
  [32, 6, 'Él es Quien conoce lo oculto y lo manifiesto. Él es el Poderoso, el Misericordioso,'],
  ...
  [32, 15, 'Solo creen en Mis signos quienes se prosternan cuando se les recitan [mis versículos], glorifican a su Señor y no se comportan con soberbia, '],
  ...
  [32, 19, 'Quienes crean y obren rectamente obtendrán los jardines del Paraíso como morada en recompensa por sus obras.'],
  ...
  [32, 25, 'Tu Señor juzgará entre ellos el Día de la Resurrección acerca de lo que discrepaban.'],
  ...
  [33, 2, 'Sigue lo que te ha sido revelado por tu Señor. Dios está bien informando de lo que hacen. '],
  [33, 3, 'Encomiéndate a Dios, porque Dios es suficiente como protector.'],
  ...
  [33, 12, 'Dijeron los hipócritas y los que tenían su corazón enfermo de dudas: "Dios y Su Mensajero solo nos han hecho promesas falsas".'],
  ...
  [33, 64, 'Dios maldice a los que rechazan el Mensaje y les ha preparado el Infierno.'],
  [33, 65, 'Estarán en él por toda la eternidad; no encontrarán quién los proteja ni los auxilie.'],
  ...
  [33, 71, '[Si lo hacen,] Él hará virtuosas sus obras y perdonará sus pecados. Quien obedece a Dios y a Su Mensajero obtendrá un triunfo grandioso.'],
  ...
  [34, 2, 'Sabe lo que ingresa en la tierra y lo que surge de ella. Lo que desciende del cielo y lo que sube hacia él. Él es el Misericordioso, el Perdonador.'],
  ...
  [34, 4, '[La Resurrección es] para recompensar a los creyentes que obraron correctamente; ellos obtendrán el perdón y un sustento generoso.'],
  ...
  [34, 27, 'Diles: "Muéstrenme los [ídolos] que asocian con Él". ¡No existen!, pues Él es Dios, el Poderoso, el Sabio.'],
  ...
  [34, 29, 'Dicen [los que se negaron a creer]: "¿Cuándo se cumplirá esta amenaza, si dices la verdad?"'],
  ...
  [34, 32, 'Dirán los [líderes] arrogantes a quienes los siguieron: "¿Acaso nosotros los apartamos de la guía [por la fuerza], después que les vino? Son unos transgresores [que eligieron libremente el descarrío]".'],
  ...
  [34, 34, 'No envié un [Profeta como] amonestador a ninguna ciudad sin que dijeran sus líderes y poderosos: "No creemos en tu Mensaje".'],
  ...
  [34, 38, 'En cambio, aquellos que se esfuercen por denigrar Mi Mensaje serán llevados al castigo.'],
  ...
  [34, 42, 'Pero el Día del Juicio no podrán beneficiarse ni perjudicarse unos a otros, y diré a los que cometieron injusticias: "Sufran el castigo del Fuego que negaban".'],
  ...
  [34, 44, 'No les concedí [a los paganos de La Meca] libros en que se basaran [y fundamentaran su idolatría], ni les envié a ningún amonestador antes de ti.'],
  ...
  [35, 15, '¡Oh, gente! Ustedes son los que necesitan de Dios, mientras que Dios es el que tiene domino absoluto y es digno de toda alabanza.'],
  [35, 16, 'Si Él quisiera, los haría desaparecer y crearía a otros seres [creyentes].'],
  [35, 17, 'Eso no sería difícil para Dios.'],
  ...
  [35, 23, 'Tú solo eres un amonestador.'],
  ...
  [35, 25, 'Pero si te desmienten, también desmintieron sus antecesores a Mis Mensajeros, que se les presentaron con pruebas y con las escrituras y el Libro luminoso.'],
  [35, 26, 'Entonces castigué a los que no creyeron, ¡y qué terrible fue Mi castigo!'],
  ...
  [35, 35, 'Nos recompensó con la morada eterna, y por Su gracia no padeceremos allí cansancio ni fatiga".'],
  ...
  [35, 38, 'Dios conoce lo oculto de los cielos y de la Tierra, y sabe bien lo que hay dentro de los corazones.'],
  ...
  [36, 7, 'Se ha hecho realidad la palabra de Dios sobre la mayoría de ellos, pues no están dispuestos a creer.'],
  ...
  [36, 17, 'Solo somos responsables de transmitir el Mensaje de forma clara".'],
  ...
  [36, 24, 'Si lo hiciera, estaría en un error evidente.'],
  ...
  [36, 33, 'Un signo [que evidencia cómo es la resurrección] es la tierra árida que revivo [con lluvias] y hago brotar de ella los granos con que se alimentan.'],
  [36, 34, 'En ella hay jardines de palmeras y vides, e hice brotar de ella manantiales'],
  [36, 35, 'para que comieran de sus frutos. No fueron las manos de ustedes las que los crearon. ¿Acaso no van a agradecer [a Dios]?'],
  [36, 36, 'Glorificado sea Aquel que creó todas las especies en pares; las que brotan de la tierra, los seres humanos y otras [criaturas] que desconocen.'],
  ...
  [36, 48, 'Y dicen [desafiantes]: "¿Cuándo se cumplirá esta advertencia, si es verdad lo que dices?"'],
  ...
  [36, 60, '¿Acaso no tomaron un compromiso conmigo, ¡oh, hijos de Adán!, de no obedecer ni adorar al demonio, que es un enemigo declarado para ustedes,'],
  [36, 61, 'y de que Me adorarían [solo a Mí]? Este es el sendero recto [que debían seguir].'],
  [36, 62, 'Pero él [el demonio] desvió a muchos de ustedes. ¿Por qué no reflexionan?'],
  [36, 63, 'Este es el Infierno que se les había prometido.'],
  ...
  [36, 74, 'Pero toman falsas divinidades, en lugar de Dios, para que los socorran.'],
  ...
  [36, 81, '¿Acaso Quien creó los cielos y la Tierra no va a poder crearlos nuevamente? ¡Sí! [Puede] Porque Él es el Creador, el que lo sabe todo.'],
  [36, 82, 'Cuando Él decide decretar algo, le dice: "¡Sé!", y es.'],
  ...
  [37, 4, 'Que su divinidad es una sola,'],
  ...
  [37, 13, 'cuando son exhortados no reflexionan,'],
  [37, 14, 'cuando ven un milagro lo ridiculizan'],
  [37, 15, 'y dicen: "Esto no es más que hechicería evidente,'],
  [37, 16, '¿acaso cuando muramos y seamos polvo y huesos, seremos resucitados?'],
  [37, 17, '¿Acaso nuestros antepasados también [serán resucitados]?"'],
  [37, 18, 'Diles [¡oh, Mujámmad!]: "Sí, y sufrirán una gran humillación".'],
  [37, 19, 'Solo bastará que se sople una vez [la trompeta y resucitarán], y entonces comenzarán a observar'],
  [37, 20, 'y dirán: "¡Ay de nosotros! En este día deberemos rendir cuentas [por nuestras obras]".'],
  [37, 21, '[Se les dirá:] "Este es el Día del Juicio que negaban".'],
  ...
  [37, 25, '[Se les preguntará:] "¿Qué sucede que no se ayudan unos a otros?"'],
  [37, 26, 'Pero ese día estarán entregados,'],
  ...
  [37, 32, 'Nosotros solo los sedujimos y ustedes nos siguieron, desviándose igual que nosotros".'],
  [37, 33, '[Entonces Dios dirá:] "Todos ustedes compartirán el castigo.'],
  [37, 34, 'Eso haré con los pecadores".'],
  [37, 35, 'Cuando se les decía: "No hay nada ni nadie con derecho a ser adorado salvo Dios", respondían con arrogancia'],
  [37, 36, 'diciendo: "¿Acaso vamos a dejar a nuestros ídolos por las palabras de un poeta loco?"'],
  [37, 37, '[Dios les dirá:] "Él se presentó con la Verdad, y corroboró el Mensaje de los Profetas que lo precedieron".'],
  [37, 38, 'Ustedes [que rechazaron el Mensaje] sufrirán un castigo doloroso.'],
  [37, 39, 'Pero sepan que solo se les retribuirá por lo que [ustedes mismos] hicieron.'],
  [37, 40, 'En cambio, los siervos sinceros de Dios,'],
  [37, 41, 'ellos tendrán la recompensa prometida:'],
  [37, 42, 'Los frutos que deseen, y serán honrados'],
  [37, 43, 'en los Jardines de las Delicias,'],
  [37, 44, 'donde estarán reclinados sobre sofás, unos frente a otros.'],
  ...
  [37, 50, 'Y se preguntarán [los creyentes en el Paraíso] unos a los otros.'],
  [37, 51, 'Uno de ellos dirá: "Yo tenía un compañero [incrédulo]'],
  ...
  [37, 54, 'Dirá [el creyente a sus compañeros del Paraíso]: "¿Quieren observar [el Infierno a ver qué ha sido de él]?"'],
  ...
  [37, 58, 'Ahora no hemos de morir'],
  [37, 59, 'después de haber pasado por la primera muerte, y no seremos castigados.'],
  [37, 60, 'Este es el éxito grandioso".'],
  [37, 61, '¡Vale la pena obrar para alcanzarlo!'],
  [37, 62, '¿Qué es mejor, esta morada [del Paraíso] o el árbol de Zaqqum?,'],
  [37, 63, 'el que puse para castigar a los que cometieron injusticias.'],
  [37, 64, 'Es un árbol que crece en lo más profundo del Infierno;'],
  ...
  [37, 73, 'Pero observa dónde terminaron aquellos que fueron advertidos,'],
  [37, 74, 'excepto los siervos fieles a Dios.'],
  ...
  [37, 80, 'Así es como recompenso a los que hacen el bien.'],
  [37, 81, 'Él era uno de Mis siervos creyentes.'],
  [37, 82, 'A los otros [los que no creyeron] los ahogué.'],
  [37, 83, 'Abraham era de los que lo siguieron [a Noé en su fe monoteísta],'],
  [37, 84, 'cuando invocó a su Señor con un corazón puro '],
  [37, 85, 'y dijo a su padre y a su pueblo: "¿Qué es lo que adoran?'],
  [37, 86, '¿Prefieren la mentira de los dioses en lugar de Dios?'],
  [37, 87, '¿Qué opinan del Señor del universo?"'],
  ...
  [37, 95, '[Abraham les dijo:] "¿Acaso adoran lo que ustedes mismos tallan?'],
  [37, 96, 'Dios es Quien los creó a ustedes y a lo que ustedes hacen".'],
  [37, 97, 'Dijeron: "Construiremos una hoguera y te arrojaremos al fuego llameante".'],
  [37, 98, 'Tramaron contra él, pero Dios [desbarató sus planes y] los humilló.'],
  [37, 99, 'Dijo [Abraham]: "Emigraré a donde mi Señor me ordene. ¡Él me guiará! '],
  [37, 100, '¡Oh, Señor mío! Concédeme un hijo justo".'],
  ...
  [37, 109, '¡Qué la paz sea con Abraham!'],
  [37, 110, 'Así es como recompenso a los que hacen el bien.'],
  [37, 111, 'Él era uno de Mis siervos creyentes.'],
  ...
  [37, 114, 'Agracié a Moisés y a Aarón,'],
  [37, 115, 'y los salvé junto con su pueblo de una gran angustia.'],
  [37, 116, 'Los socorrí, y fueron ellos los vencedores.'],
  [37, 117, 'Les concedí un Libro esclarecedor,'],
  [37, 118, 'y los guie por el sendero recto.'],
  [37, 119, 'Y dejé su historia [como enseñanza] para la posteridad,'],
  [37, 120, '¡Que la paz sea con Moisés y Aarón!'],
  [37, 121, 'Así es como recompenso a los que hacen el bien.'],
  [37, 122, 'Ambos eran de Mis siervos creyentes.'],
  ...
  [37, 127, 'Pero lo desmintieron, y tendrán que comparecer.'],
  [37, 128, 'Excepto los siervos fieles a Dios.'],
  [37, 129, 'Dejé su historia [como enseñanza] para la posteridad.'],
  [37, 130, '¡Qué la paz sea con Elías!'],
  [37, 131, 'Así es como recompenso a los que hacen el bien.'],
  [37, 132, 'Él era uno de Mis siervos creyentes.'],
  [37, 133, 'Lot también fue de Mis Mensajeros.'],
  [37, 134, 'Lo salvé a él y a toda su familia,'],
  [37, 135, 'excepto a su mujer, que se sentenció [a ella misma] junto a los condenados.'],
  [37, 136, 'Luego aniquilé a los demás.'],
  ...
  [37, 148, 'y todos creyeron, y los dejé disfrutar hasta que la muerte les llegó.'],
  ...
  [37, 150, '¿Acaso fueron testigos cuando creé a los ángeles, para afirmar que son de sexo femenino?'],
  [37, 151, 'Entre las mentiras que inventaron:'],
  [37, 152, '"Dios ha engendrado". Mienten.'],
  [37, 153, '¿Escogió a las hijas sobre los hijos [siendo el creador de ambos]?'],
  [37, 154, '¿Qué les pasa? ¿Cómo es que juzgan?'],
  [37, 155, '¿No van a pensar [antes de hablar]?'],
  [37, 156, '¿O acaso tienen una prueba válida [de lo que afirman]?'],
  [37, 157, 'Traigan entonces el libro, si son veraces.'],
  ...
  [37, 159, '¡Glorificado sea Dios! Él está por encima de lo que Le atribuyen.'],
  [37, 160, 'Excepto los siervos fieles de Dios [que no le asocian nada ni lo describen como no es propio de Él].'],
  ...
  [37, 170, 'Pero cuando les llegó lo negaron. ¡Ya verán [el castigo que les aguarda]!'],
  [37, 171, 'Fue decretado para Mis siervos Mensajeros'],
  [37, 172, 'que serían auxiliados,'],
  [37, 173, 'y que Mi ejército sería el vencedor.'],
  ...
  [37, 176, '¿Acaso quieren que se precipite Mi castigo? '],
  ...
  [37, 178, 'Apártate [¡oh, Mujámmad!] de los que rechazan el Mensaje por un tiempo,'],
  [37, 179, 'y ten paciencia, que ya pronto verán [el castigo que les aguarda].'],
  [37, 180, '¡Glorificado sea tu Señor, el dueño del poder absoluto! Él está por encima de lo que Le atribuyen.'],
  [37, 181, '¡Que la paz sea con todos los Mensajeros!'],
  ...
  [38, 14, 'Todos ellos desmintieron a los Mensajeros, y merecieron Mi castigo.'],
  ...
  [38, 27, 'No he creado el cielo, la Tierra y todo cuanto hay entre ambos en vano. Eso es lo que creen los que rechazan la verdad, pero, ¡ay de los incrédulos! ¡Qué [castigo les aguarda en] el Infierno!'],
  ...
  [38, 38, 'y otros [demonios rebeldes] encadenados unos con otros.'],
  ...
  [38, 40, 'Salomón es de Mis allegados, y por eso [en la otra vida] tendrá una bella morada [en el Paraíso].'],
  ...
  [38, 43, 'Lo agracié con hijos [como los que tenía] y tantos más, como una misericordia mía, para que sea un recuerdo y motivo de reflexión para los dotados de intelecto.'],
  ...
  [38, 47, 'Ellos se cuentan entre los virtuosos que he elegido [para transmitir el Mensaje].'],
  [38, 48, 'Y recuerda a Ismael, Eliseo y Dhul Kifl; todos ellos también se contaron entre los virtuosos [que elegí para trasmitir el Mensaje].'],
  [38, 49, 'Este es un Mensaje [para toda la humanidad]. Los piadosos tendrán una bella morada'],
  [38, 50, 'en los Jardines del Edén. Todas sus puertas estarán abiertas para ellos.'],
  [38, 51, 'Estarán recostados [sobre sofás], y pedirán frutas abundantes y [exquisitas] bebidas,'],
  ...
  [38, 56, 'Este es el Infierno donde sufrirán. ¡Qué pésima morada!'],
  ...
  [38, 60, 'Dirán [los seguidores]: "Tampoco hay bienvenida para ustedes, pues fueron quienes nos arrastraron [al Infierno]". ¡Qué pésima morada [para todos ellos]!'],
  [38, 61, 'Dirán [los seguidores]: "¡Oh, Señor nuestro! Duplícales el castigo del Fuego a quienes nos arrastraron a esto".'],
  ...
  [38, 64, 'Así será la disputa entre los moradores del Infierno.'],
  [38, 65, 'Diles [¡oh, Mujámmad!]: "Solo soy un amonestador. No existe nada ni nadie con derecho a ser adorado salvo Dios, el Único, el Victorioso,'],
  [38, 66, 'Señor de los cielos, de la Tierra, y de todo cuanto existe entre ellos, el Poderoso, el Remisorio".'],
  [38, 67, 'Diles: "Lo que les he transmitido es un Mensaje sublime,'],
  [38, 68, 'pero lo rechazan.'],
  ...
  [38, 71, 'Recuerda [¡oh, Mujámmad!] cuando tu Señor dijo a los ángeles: "Voy a crear un hombre de barro.'],
  [38, 72, 'Y cuando lo haya plasmado y haya soplado en él su espíritu, hagan una reverencia [en obediencia a Mí] ante él".'],
  [38, 73, 'Todos los ángeles hicieron la reverencia.'],
  [38, 74, 'Excepto Iblís, quien fue soberbio y se contó entre los incrédulos.'],
  ...
  [38, 76, 'Dijo [Iblís]: "Yo soy superior a él. A mí me creaste de fuego, mientras que a él lo creaste de barro".'],
  [38, 77, 'Dijo Dios: "Sal de aquí, pues te maldigo.'],
  [38, 78, 'Y esta maldición pesará sobre ti hasta el Día del Juicio".'],
  [38, 79, 'Dijo [Iblís]: "¡Oh, Señor mío! Permíteme vivir hasta el Día de la Resurrección".'],
  [38, 80, 'Dijo Dios: "Te concedo la prórroga que Me pides,'],
  [38, 81, 'hasta el día cuyo término está prefijado".'],
  [38, 82, 'Dijo [Iblís]: "¡Juro por Tu poder que los descarriaré a todos,'],
  [38, 83, 'excepto a quienes de Tus siervos hayas protegido!"'],
  [38, 84, 'Dijo Dios: "La verdad es [lo que he jurado], y la verdad declaro:'],
  [38, 85, 'He de llenar el Infierno contigo y todos los que te sigan".'],
  ...
  [38, 87, 'El Corán es un Mensaje para toda la humanidad.'],
  [38, 88, 'Y dentro de poco tiempo verán lo que en él se anuncia".'],
  [39, 1, 'La revelación de este Libro proviene de Dios, el Poderoso, el Sabio.'],
  ...
  [39, 11, 'Diles: "Me ha sido ordenado adorar solamente a Dios, y rendirle culto sincero,'],
  [39, 12, 'y me ha sido ordenado que sea el primero en someterse a Él".'],
  [39, 13, 'Diles: "Pero yo temo, si desobedezco [las órdenes de] mi Señor, el castigo en un día difícil [el Día del Juicio]".'],
  [39, 14, 'Diles: "Yo adoro solamente a Dios, y Le rindo culto sincero.'],
  ...
  [39, 16, 'Serán cubiertos por encima y por debajo por nubes de fuego. Así atemoriza Dios a Sus siervos. ¡Oh, siervos Míos! Tengan temor de Mí [y crean].'],
  ...
  [39, 25, 'Otras personas en la antigüedad desmintieron [a los Mensajeros], pero fueron sorprendidos por el castigo desde donde menos lo esperaban.'],
  ...
  [39, 34, 'Ellos tendrán cuanto deseen junto a su Señor. Esa será la recompensa de los que hacen el bien.'],
  ...
  [39, 39, 'Diles: "¡Oh, pueblo mío! Obren como quieran, que yo obraré [acorde a lo que me ha sido revelado]. Ya sabrán'],
  [39, 40, 'a quién le corresponde el castigo humillante, y quién recibirá un castigo eterno [en la otra vida]".'],
  ...
  [39, 62, 'Dios es el Creador de todas las cosas, y Él es su Custodio.'],
  ...
  [39, 70, 'Será juzgada cada alma acorde a sus obras, y Él es Quien mejor sabe cuanto hicieron.'],
  ...
  [39, 72, 'Se les dirá: "Entren por las puertas del Infierno, y morarán allí por toda la eternidad". ¡Qué pésima morada tendrán los soberbios!'],
  ...
  [40, 1, 'Ha’. Mim.'],
  [40, 2, 'La revelación de este Libro proviene de Dios, el Poderoso, el que todo lo sabe.'],
  ...
  [40, 14, 'Invoquen a Dios y adórenlo con sinceridad, aunque eso disguste a los que se niegan a creer.'],
  ...
  [40, 30, 'Pero dijo el hombre que creía [de la familia del Faraón]: "¡Oh, pueblo mío! Temo que les ocurra lo mismo que a los aliados [incrédulos que se complotaron contra sus Mensajeros],'],
  ...
  [40, 40, 'Quien haga una maldad, será castigado acorde a lo cometido, pero quien haga obras buenas y sea creyente, varón o mujer, ingresará al Paraíso y será recompensado sin medida.'],
  [40, 41, '¡Oh, pueblo mío! ¿Qué sucede que los invito a la salvación y ustedes me invitan al Infierno?'],
  [40, 42, 'Me proponen negar la unicidad de Dios y que dedique actos de adoración a otros [ídolos], pero no tengo conocimiento [que algo merezca ser adorado salvo Él]. Yo los invito a creer en el Poderoso, el Perdonador.'],
  ...
  [40, 54, 'como guía y motivo de reflexión para los dotados de entendimiento.'],
  ...
  [40, 57, 'La creación de los cielos y de la Tierra es más grandiosa que la creación de los seres humanos, pero la mayoría de ellos lo ignoran.'],
  ...
  [40, 62, 'Aquel [que los agracia] es Dios, su Señor, el Creador de todas las cosas, no hay nada ni nadie con derecho a ser adorado salvo Él, ¿cómo es que rehúsan [adorarlo a Él y adoran falsas divinidades]?'],
  [40, 63, 'Así también fueron apartados [del camino recto] quienes rechazaron los signos de Dios.'],
  ...
  [40, 68, 'Él es Quien da la vida y da la muerte, y cuando decreta algo dice: "¡Sé!", y es.'],
  ...
  [40, 76, 'Ingresen [al castigo] por las puertas del Infierno, donde permanecerán por toda la eternidad". ¡Qué pésima será la morada de los soberbios!'],
  ...
  [41, 15, 'En cuanto a ‘Ad, actuaron con soberbia y cometieron injusticias en la tierra. Dijeron: "¿Acaso existe alguien más poderoso que nosotros?" ¿Acaso no sabían que Dios es Quien los creó y que Él es más poderoso que ellos? Pero rechazaron Mis signos.'],
  ...
  [41, 18, 'Pero salvé a quienes habían creído y tenían temor de Dios.'],
  [41, 19, 'El día que sean congregados los enemigos de Dios y conducidos al Infierno,'],
  ...
  [41, 27, 'Les haremos sufrir un castigo severo a los que se negaron a creer, retribuyéndolos por todo el mal que hicieron.'],
  ...
  [41, 32, 'como reconocimiento del Absolvedor, Misericordioso".'],
  ...
  [41, 41, 'Quienes se negaron a creer en el Mensaje cuando les llegó, sepan que este es un Libro sublime.'],
  ...
  [42, 4, 'A Él pertenece cuanto hay en los cielos y en la Tierra. Él es el Sublime, el Grandioso.'],
  ...
  [42, 6, 'Quienes tomaron a otros [como divinidades y objeto de adoración] en lugar de Dios, deben saber que Dios tiene registradas todas sus obras; pero tú [¡oh, Mujámmad!] no eres responsable de lo que ellos hagan.'],
  ...
  [42, 9, '¿Acaso toman a los ídolos como protectores en lugar de Dios? Dios es el Protector, Él resucitará a los muertos, porque tiene poder sobre todas las cosas [y por eso es que solo Él es Quien merece ser adorado].'],
  ...
  [42, 29, 'Entre Sus signos está la creación de los cielos, de la Tierra y de todas las criaturas que diseminó en ella. Él tiene poder para congregarlos a todos cuando quiera.'],
  ...
  [42, 31, 'No hay lugar en la Tierra al que puedan escapar de Dios. No tienen protector ni socorredor fuera de Dios.'],
  ...
  [42, 42, 'Los que deben ser reprochados son quienes oprimen a la gente y se comportan con soberbia en la Tierra sin derecho alguno. Esos sufrirán un castigo doloroso.'],
  ...
  [43, 21, '¿Acaso les envié un libro [anterior al Corán] en el que se basan?'],
  ...
  [43, 27, 'Yo solo adoro a Quien me creó. Él me guiará".'],
  ...
  [43, 30, 'Pero cuando se les presentó con la Verdad dijeron [los idólatras]: "Esto es hechicería, nosotros no creemos en él".'],
  ...
  [43, 43, 'Aférrate a lo que te fue revelado, tú estás en el sendero recto.'],
  ...
  [43, 46, 'Envié a Moisés con Mis signos ante el Faraón y su nobleza, y les dijo: "Soy un Mensajero del Señor del universo".'],
  ...
  [43, 62, 'Tengan cuidado de que no los desvíe el demonio, porque él es su enemigo declarado".'],
  ...
  [43, 64, 'Dios es mi Señor y el de ustedes, adórenlo, entonces. Éste es el sendero recto".'],
  ...
  [43, 69, 'pues creyeron en Mis signos y fueron musulmanes.'],
  ...
  [43, 74, 'Mientras que los transgresores estarán en el Infierno por toda la eternidad.'],
  [43, 75, 'No se les aliviará [el castigo] ni tendrán esperanza [de salir algún día].'],
  [43, 76, 'No seré injusto con ellos, sino que ellos fueron injustos consigo mismos.'],
  ...
  [43, 82, '¡Glorificado sea el Señor de los cielos y de la Tierra, Señor del Trono! Él está por encima de lo que Le atribuyen".'],
  ...
  [43, 87, 'Si les preguntas [a los que se niegan a creer] quién los ha creado, te responderán: "¡Dios!" ¿Cómo entonces se descarrían?'],
  ...
  [44, 8, 'No hay nada ni nadie con derecho a ser adorado salvo Dios; Él da la vida y da la muerte. Él es su Señor y el de sus ancestros.'],
  [44, 9, 'Pero ellos juegan con las dudas.'],
  ...
  [44, 22, 'Pero invocó a su Señor diciendo: "Éste es un pueblo de criminales".'],
  ...
  [44, 30, 'Salvé a los Hijos de Israel de un tormento humillante'],
  ...
  [44, 34, 'Pero ellos dicen:'],
  [44, 35, '"Solo moriremos una vez, y no seremos resucitados.'],
  [44, 36, 'Resucita a nuestros padres, si es que eres veraz".'],
  ...
  [44, 38, 'No he creado a los cielos, la Tierra y todo lo que hay entre ellos como un simple juego.'],
  [44, 39, 'Los creé con un fin justo y verdadero, pero la mayoría de la gente lo ignora.'],
  [44, 40, 'El Día del Juicio es una cita establecida para todos.'],
  ...
  [44, 44, 'será la comida del pecador.'],
  ...
  [44, 48, 'Luego viertan sobre su cabeza el castigo hirviente".'],
  [44, 49, '¡Súfrelo! [Porque en la vida mundanal pensabas que] eras "el poderoso" y "el noble".'],
  [44, 50, 'Esto es sobre lo que dudabas.'],
  [44, 51, 'Pero los piadosos estarán en una situación segura,'],
  [44, 52, 'en jardines y manantiales.'],
  [44, 53, 'Vestirán fina seda y brocado, y se sentarán unos frente a otros.'],
  [44, 54, 'Los desposaremos con huríes de grandes ojos.'],
  [44, 55, 'Allí podrán pedir toda clase de frutas. Estarán en total seguridad.'],
  [44, 56, 'No experimentarán otra vez la muerte, salvo la que ya conocieron. Él los preservará del castigo infernal.'],
  [44, 57, 'Ese es el favor de tu Señor. ¡Ese es el gran éxito!'],
  ...
  [45, 1, 'Ha’. Mim.'],
  [45, 2, 'Este Libro es una revelación que proviene de Dios, el Poderoso, el Sabio.'],
  ...
  [45, 7, '¡Ay de todo mentiroso, pecador!'],
  ...
  [45, 12, 'Dios es Quien hizo que el mar estuviera a su servicio, para que los barcos navegaran sobre él por Su designio y así pudieran procurar el sustento. Sean agradecidos con Dios.'],
  ...
  [45, 16, 'Le di a los Hijos de Israel el Libro, la sabiduría, la profecía y un sustento generoso, y los distinguí entre sus contemporáneos.'],
  ...
  [45, 19, 'porque ellos no te beneficiarán en nada ante Dios. Los opresores se alían unos con otros, pero Dios es el Protector de los piadosos.'],
  ...
  [45, 27, 'A Dios pertenece la soberanía de los cielos y de la Tierra. El día que llegue la Hora, ese día perderán los seguidores de la falsedad.'],
  ...
  [45, 30, 'A quienes creyeron y obraron rectamente, su Señor los introducirá en Su misericordia. Ese es el éxito verdadero.'],
  ...
  [45, 36, 'Solo Dios merece ser alabado. Es el Señor de los cielos, el Señor de la Tierra y el Señor de los universos.'],
  [45, 37, 'Suya es la majestuosidad en los cielos y en la Tierra, y Él es el Poderoso, el Sabio.'],
  [46, 1, 'Ha’. Mim.'],
  [46, 2, 'Este Libro es una revelación que proviene de Dios, el Poderoso, el Sabio.'],
  [46, 3, 'No creé los cielos y la Tierra y lo que hay entre ambos sino con la verdad y por un plazo determinado. Pero los que se niegan a creer rechazan las advertencias.'],
  ...
  [46, 5, '¿Existe alguien más extraviado que aquellos que invocan en lugar de Dios a quienes jamás les responderán sus súplicas porque no son conscientes de ellas?'],
  ...
  [46, 7, 'Cuando se les recitan Mis versículos esclarecedores de la verdad, los que se niegan a creer dicen acerca de la Verdad que les ha llegado: "Esto es hechicería".'],
  ...
  [46, 13, 'Quienes digan: "¡Nuestro Señor es Dios!, y luego obren correctamente, no tienen de qué sentir temor ni estar tristes [en el Día del Juicio Final]'],
  [46, 14, 'porque serán los compañeros del Paraíso, en el que vivirán por toda la eternidad como recompensa por sus obras.'],
  ...
  [46, 23, 'Dijo [el Profeta Hud]: "Solo Dios sabe cuándo llegará [ese día], yo solo les transmito el Mensaje con el que fui enviado, pero veo que son un pueblo que se comporta como los ignorantes".'],
  ...
  [46, 30, 'Dijeron: "¡Oh, pueblo nuestro! Hemos oído un Libro revelado después de Moisés, que corrobora los Mensajes anteriores y guía hacia la Verdad y el camino recto.'],
  ...
  [47, 9, 'porque repudiaron lo que Dios descendió en la revelación, y como consecuencia sus obras se perderán.'],
  ...
  [47, 12, 'Dios introducirá a los creyentes que obran rectamente en jardines por donde corren ríos. En cambio, los que se niegan a creer gozarán transitoriamente y comerán como lo hacen los rebaños, pero tendrán el Infierno por morada.'],
  ...
  [47, 14, '¿Acaso quien se aferra a una evidencia clara de su Señor puede compararse con quien [seducido por el demonio] ve sus obras malas como buenas y sigue sus pasiones?'],
  ...
  [47, 34, 'A los que se nieguen a creer, se opongan al camino de Dios y mueran en la incredulidad, Dios no ha de perdonarlos.'],
  ...
  [48, 7, 'A Dios pertenecen los ejércitos de los cielos y de la Tierra. Dios es Poderoso, Sabio.'],
  ...
  [48, 14, 'A Dios pertenece el reino de los cielos y de la Tierra, perdona a quien Él quiere y castiga a quien Él quiere. Dios es Absolvedor, Misericordioso.'],
  ...
  [48, 19, 'donde obtuvieron un botín cuantioso. Dios es Poderoso, Sabio.'],
  ...
  [48, 28, 'Él es Quien les envió a Su Mensajero con la guía y la práctica de adoración verdadera, para que prevalezca sobre todas las demás. Dios es suficiente como testigo.'],
  ...
  [49, 15, 'Los verdaderos creyentes son quienes creen en Dios y en Su Mensajero, y luego no vacilan; quienes luchan por la causa de Dios con sus bienes materiales y sus personas. Esos son los sinceros.'],
  ...
  [50, 12, 'Antes que ellos ya lo habían hecho el pueblo de Noé, los habitantes de Rass y Zamud,'],
  ...
  [50, 20, 'La trompeta será inevitablemente soplada. Ese es un día prometido.'],
  ...
  [50, 26, 'y asoció divinidades a Dios [en la adoración]. ¡Arrójenlo al castigo severo!"'],
  ...
  [50, 42, 'ese día todos escucharán el soplido que anuncia la verdad. Ese será el Día de la Resurrección.'],
  ...
  [51, 12, 'y preguntan: "¿Cuándo será el Día del Juicio?"'],
  ...
  [51, 15, 'Los piadosos, en cambio, morarán en jardines con manantiales.'],
  ...
  [51, 20, 'En la Tierra hay signos para quienes tienen certeza interior.'],
  ...
  [51, 30, 'Le dijeron: "Así lo ha decretado tu Señor, y Él es el Sabio, el que lo sabe todo".'],
  [51, 31, 'Dijo [Abraham]: "¡Oh, emisarios! ¿Cuál es su misión?" '],
  [51, 32, 'Dijeron: "Fuimos enviados a un pueblo de criminales'],
  ...
  [51, 48, 'Extendí la Tierra [haciéndola propicia para habitar], y con qué excelencia lo he hecho. '],
  ...
  [51, 51, 'No dediquen actos de adoración a otros que Dios, Yo soy para ustedes un amonestador que habla claro".'],
  ...
  [51, 60, '¡Cuán desdichados serán los que negaron la verdad el día que se les ha prometido!'],
  ...
  [52, 10, 'y las montañas se muevan,'],
  [52, 11, '¡Cuán desdichados serán ese día los que rechazaron la verdad!,'],
  [52, 12, 'aquellos que en su ignorancia se burlaban.'],
  [52, 13, 'El día que sean empujados al fuego del Infierno,'],
  [52, 14, '[se les dirá:] "Este es el Fuego que desmentían.'],
  [52, 15, '¿Acaso les parece esto una hechicería, o es que no ven?'],
  [52, 16, 'Entren en él, lo soporten o no, será igual. Solo se los castiga por lo que obraron".'],
  [52, 17, 'En cambio, los piadosos morarán en jardines y deleite.'],
  ...
  [52, 22, 'Los agraciaremos con tanta fruta y carne como la que deseen.'],
  ...
  [52, 25, 'Y [los bienaventurados] se preguntarán unos a otros.'],
  [52, 26, 'Dirán: "Cuando estábamos viviendo junto a nuestra familia, teníamos temor,'],
  ...
  [52, 36, '¿O crearon los cielos y la Tierra? No tienen certeza de nada.'],
  ...
  [52, 39, '¿Acaso a Dios Le pertenecen las hijas mujeres y a ellos los hijos varones?'],
  ...
  [52, 42, '¿O es que quieren tenderte una trampa? Los que se niegan a creer son quienes han caído en una trampa.'],
  [52, 43, '¿O acaso tienen otra divinidad además de Dios? ¡Glorificado sea Dios de cuanto Le asocian!'],
  ...
  [53, 24, '¿Acaso cree el ser humano que obtendrá todo cuanto ambiciona?'],
  [53, 25, 'A Dios le pertenecen esta vida y la otra.'],
  ...
  [53, 27, 'Quienes no creen en la otra vida, le dan a los ángeles nombres femeninos'],
  ...
  [53, 29, 'Apártate de quienes rechazan Mi Mensaje y no desean sino [el materialismo de] la vida mundanal.'],
  ...
  [53, 31, 'A Dios pertenece cuanto hay en los cielos y en la Tierra, y Él castigará a quienes obren el mal y retribuirá con una hermosa recompensa a los que hagan el bien,'],
  ...
  [53, 40, 'que sus esfuerzos se verán,'],
  ...
  [53, 44, 'Él es Quien causa la muerte y la vida,'],
  [53, 45, 'Él ha creado la pareja: el macho y la hembra,'],
  [53, 46, 'de una gota de esperma eyaculada.'],
  [53, 47, 'Él es Quien los creará por segunda vez.'],
  ...
  [53, 53, 'Y a la ciudad que cayó al revés,'],
  ...
  [54, 10, 'Entonces [Noé] invocó a su Señor: "¡Me han vencido, Te pido ayuda!"'],
  ...
  [54, 16, '¡Qué severos fueron Mi castigo y Mi advertencia!'],
  ...
  [54, 22, 'He hecho el Corán fácil de entender y memorizar. Pero, ¿habrá alguien que lo reflexione?'],
  [54, 23, 'El pueblo de Zamud desmintió las advertencias.'],
  ...
  [54, 30, '¡Y qué severos fueron Mi castigo y Mi advertencia!'],
  ...
  [54, 33, 'El pueblo de Lot desmintió la advertencia.'],
  [54, 34, 'Les envié una tormenta de piedras, salvo a la familia de Lot, a quienes salvé al amanecer'],
  [54, 35, 'como una gracia de Mi parte, porque así retribuyo a quienes son agradecidos.'],
  ...
  [54, 39, '¡Sufran Mi castigo y Mi advertencia!'],
  [54, 40, 'Hemos hecho el Corán fácil de entender y memorizar. Pero, ¿habrá alguien que reflexione?'],
  ...
  [54, 47, 'Los que hacen el mal están en un estado de extravío y locura.'],
  ...
  [54, 52, 'Todo cuanto obraron se encuentra registrado en el libro de sus obras.'],
  [54, 53, 'Y todo cuanto ocurre, importante o insignificante, está escrito.'],
  [54, 54, 'Los piadosos estarán entre jardines y ríos,'],
  [54, 55, 'en un lugar honorable, junto al Soberano Todopoderoso.'],
  [55, 1, 'El Compasivo'],
  [55, 2, 'enseñó el Corán,'],
  ...
  [55, 16, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 17, 'El Señor de los dos nacientes y los dos ponientes.'],
  [55, 18, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 19, 'Hizo que las dos grandes masas de agua se encuentren,'],
  [55, 20, 'pero dispuso entre ambas una barrera que no transgreden.'],
  [55, 21, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 22, 'De ambas se extraen perlas y corales.'],
  [55, 23, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 24, 'Suyas son las embarcaciones que sobresalen en el mar como montañas.'],
  [55, 25, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 26, 'Todo cuanto existe en la Tierra perecerá,'],
  [55, 27, 'y solo el rostro de tu Señor perdurará por siempre, el Majestuoso y el Noble.'],
  [55, 28, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  ...
  [55, 30, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 31, 'Me encargaré de los que cargan con el libre albedrío.'],
  [55, 32, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  ...
  [55, 34, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  ...
  [55, 38, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 39, 'Ese día no será necesario preguntarles por sus pecados a los seres humanos ni a los yinnes.'],
  [55, 40, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 41, 'Los pecadores serán reconocidos por su aspecto, y se les tomará por la frente y por los pies.'],
  [55, 42, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 43, 'Este es el Infierno que desmentían los criminales.'],
  [55, 44, 'No dejarán de ir y venir entre el fuego y un agua hirviente.'],
  [55, 45, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 46, 'Para quien haya tenido temor de comparecer ante su Señor habrá dos jardines.'],
  [55, 47, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 48, '[Jardines] frondosos.'],
  [55, 49, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 50, 'En cada uno habrá dos manantiales.'],
  [55, 51, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 52, 'En cada uno habrá dos especies de cada fruta.'],
  [55, 53, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 54, 'Estarán reclinados en sofás tapizados de brocado, y la fruta de ambos jardines estará al alcance de la mano.'],
  [55, 55, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 56, 'Habrá en ellos mujeres de mirar recatado, que no fueron tocadas antes por ningún ser humano ni tampoco un yinn.'],
  [55, 57, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 58, 'Ellas serán de una belleza semejante al rubí y al coral.'],
  [55, 59, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 60, '¿Acaso la recompensa del bien no es el bien mismo?'],
  [55, 61, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 62, 'Además de esos dos, habrá otros dos jardines.'],
  [55, 63, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 64, 'De profundo verdor.'],
  [55, 65, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 66, 'En ambos habrá dos manantiales brotando.'],
  [55, 67, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 68, 'Habrá frutas, datileras y granadas.'],
  [55, 69, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 70, 'Y también habrá buenas y hermosas [mujeres].'],
  [55, 71, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 72, 'Huríes, retiradas en bellas moradas.'],
  [55, 73, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 74, 'Que no fueron tocadas antes por ningún ser humano ni tampoco un yinn.'],
  [55, 75, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  [55, 76, '[Los bienaventurados] estarán reclinados sobre cojines verdes y hermosas alfombras.'],
  [55, 77, '¿Acaso pueden negar alguna de las gracias que les ha concedido su Señor?'],
  ...
  [56, 7, 'serán divididos en tres grupos:'],
  ...
  [56, 12, 'estarán en los Jardines de las Delicias.'],
  ...
  [56, 16, 'y se recostarán en ellos, unos enfrente de otros.'],
  ...
  [56, 23, 'como si fueran perlas ocultas.'],
  [56, 24, 'En recompensa por las obras buenas que solían hacer.'],
  [56, 25, 'No oirán frivolidades ni incitación al pecado,'],
  ...
  [56, 30, 'de sombra extensa.'],
  [56, 31, 'Habrá agua de continuo fluir'],
  [56, 32, 'y frutos abundantes, '],
  [56, 33, 'que no se agotarán y siempre estarán al alcance de sus manos.'],
  [56, 34, '[Reposarán] en camas elevadas.'],
  [56, 35, 'Las creé [a las mujeres del Paraíso] de manera especial,'],
  [56, 36, 'vírgenes,'],
  [56, 37, 'amorosas y siempre con la misma edad.'],
  [56, 38, 'Esto es para los compañeros de la derecha.'],
  [56, 39, 'Muchos de ellos serán de las primeras generaciones,'],
  [56, 40, 'y muchos serán de las últimas generaciones.'],
  [56, 41, '¡Pero qué desafortunados serán los compañeros de la izquierda!'],
  [56, 42, 'Atormentados por un viento abrasador y un líquido hirviente,'],
  [56, 43, 'a la sombra de un humo negro,'],
  [56, 44, 'que no será fresca ni agradable.'],
  [56, 45, 'Porque se entregaron a los lujos superfluos,'],
  [56, 46, 'se aferraron al más terrible pecado'],
  [56, 47, 'y preguntaban burlándose: "¿Acaso cuando muramos y ya seamos tierra y huesos, vamos a ser resucitados?'],
  [56, 48, '¿Y nuestros ancestros también?"'],
  [56, 49, 'Respóndeles: "Los primeros y los últimos'],
  [56, 50, 'serán congregados en un día ya establecido.'],
  [56, 51, 'Luego, ¡oh, extraviados y desmentidores!,'],
  [56, 52, 'han de comer del árbol del Zaqqum'],
  ...
  [56, 56, 'Esa será su morada el Día del Juicio.'],
  [56, 57, 'Yo los creé, ¿por qué no aceptan la verdad?'],
  [56, 58, '¿Por qué no reflexionan en lo que eyaculan?'],
  ...
  [56, 71, '¿No han observado el fuego que encienden?'],
  ...
  [56, 74, 'Glorifica el nombre de tu Señor, el Grandioso.'],
  [56, 75, '¡Juro por las estrellas cuando desaparecen!'],
  [56, 76, 'Lo cual, si supieran, es un juramento grandioso. '],
  [56, 77, 'Que este es un Corán Noble,'],
  [56, 78, 'preservado en un libro custodiado,'],
  [56, 79, 'que solo pueden tocar los purificados.'],
  [56, 80, 'Es una revelación descendida por el Señor del universo.'],
  ...
  [56, 85, 'pero Yo estoy más cerca que ustedes de él, aunque no lo vean;'],
  ...
  [56, 94, 'y luego será arrojado al fuego del Infierno.'],
  [56, 95, 'esta es la Verdad sobre la que no hay duda.'],
  [56, 96, '¡Glorifica el nombre de tu Señor, el Grandioso!'],
  ...
  [57, 3, 'Él es el Primero y el Último, el Manifiesto y el Oculto. Él conoce todas las cosas.'],
  ...
  [57, 5, 'Suyo es el reino de los cielos y de la Tierra. Y a Dios retornan todos los asuntos.'],
  [57, 6, 'Hace que la noche suceda al día y que el día suceda a la noche. Él conoce todo lo que encierran los corazones.'],
  ...
  [57, 17, 'Sepan que Dios da vida a la tierra árida. Les explico estos signos para que reflexionen.'],
  ...
  [57, 26, 'Envié a Noé y a Abraham, y agracié a la descendencia de ambos con la profecía y el Libro. Entre sus descendientes hubo quienes siguieron la guía, aunque muchos de ellos fueron corruptos.'],
  ...
  [58, 6, 'El día que Dios los resucite a todos, les informará cuanto hicieron. Dios registró sus obras, mientras que ellos las olvidaron. Dios es testigo de todo.'],
  ...
  [58, 15, 'Dios les ha preparado un castigo severo por el mal que cometieron.'],
  ...
  [59, 13, 'Ellos les temen más a ustedes en su corazón que a Dios, porque son un pueblo que no comprende [la grandeza de Dios].'],
  ...
  [59, 20, 'No se equiparan los compañeros del Infierno con los compañeros del Paraíso. Los compañeros del Paraíso son los que triunfan.'],
  ...
  [59, 22, 'Él es Al-lah, no hay otra divinidad salvo Él, el Conocedor de lo oculto y de lo manifiesto. Él es el Compasivo, el Misericordioso.'],
  ...
  [61, 1, 'Todo cuanto existe en los cielos y en la Tierra glorifica a Dios. Él es el Poderoso, el Sabio.'],
  ...
  [61, 7, '¿Existe alguien más injusto que quien inventa mentiras acerca de Dios cuando es invitado al Islam? Dios no guía a los injustos.'],
  ...
  [63, 5, 'Cuando se les dice: "Vengan, que el Mensajero de Dios pedirá perdón por ustedes", mueven su cabeza [en señal de burla] y los ves evadirte con soberbia.'],
  ...
  [64, 1, 'Todo cuanto existe en los cielos y en la Tierra glorifica a Dios. Suyo es el reino y Suyas son las alabanzas. Él tiene poder sobre todas las cosas.'],
  ...
  [64, 3, 'Dios creó los cielos y la Tierra con un fin justo y verdadero, y les dio una conformación armoniosa. Ante Él comparecerán para responder por sus obras.'],
  [64, 4, 'Dios conoce cuanto existe en los cielos y en la Tierra, conoce lo que ocultan y lo que manifiestan. Dios sabe bien lo que esconden los corazones.'],
  [64, 5, '¿Acaso no les fue relatada la historia de los pueblos de la antigüedad que rechazaron el Mensaje? Sufrieron las consecuencias de su conducta y les espera un castigo doloroso.'],
  ...
  [64, 8, 'Crean en Dios, en Su Mensajero y en la Luz que ha revelado [el Corán]. Dios está bien informado de cuanto hacen.'],
  ...
  [64, 10, 'En cambio, los que rechazaron el Mensaje y desmintieron Mis signos sufrirán en el fuego del Infierno por toda la eternidad. ¡Qué pésimo destino!'],
  ...
  [64, 13, '¡Al-lah! No existe divinidad excepto Él. Que los creyentes depositen su confianza en Dios.'],
  ...
  [64, 18, 'conoce lo oculto y lo manifiesto, Él es el Poderoso, el Sabio.'],
  ...
  [65, 5, 'Estas son las leyes que Dios ha prescrito. A quien tenga temor de Dios, Él le perdonará sus malas obras y le aumentará su recompensa.'],
  ...
  [65, 9, 'Ellos sufrieron las consecuencias de sus obras. Su final fue la perdición.'],
  ...
  [66, 7, '[El Día del Juicio se les dirá:] ¡Los que rechazaron el Mensaje! Hoy no pretendan excusarse, simplemente recibirán el merecido por lo que hayan hecho.'],
  ...
  [66, 9, '¡Profeta! Haz frente a los que rechazaron el Mensaje y a los hipócritas, y sé riguroso con ellos. [Si no se arrepienten ante Dios] tendrán el Infierno por morada. ¡Qué pésimo destino!'],
  ...
  [67, 1, 'Bendito sea Aquel en Cuyas manos está el reino y tiene el poder sobre todas las cosas.'],
  ...
  [67, 6, 'Para quienes no creen en su Señor les tengo preparado el castigo del Infierno. ¡Qué pésimo destino!'],
  [67, 7, 'Cuando sean arrojados en el Infierno, oirán su fragor mientras hierve,'],
  ...
  [67, 10, 'Y agregarán: "Si hubiéramos oído o reflexionado, no estaríamos ahora con los condenados al Fuego".'],
  [67, 11, 'Entonces reconocerán sus pecados, pero qué lejos están los condenados al fuego de la misericordia de Dios".'],
  [67, 12, '[En cambio] quienes fueron temerosos de su Señor en privado [cuando solo Él los observaba] serán perdonados y recibirán una gran recompensa.'],
  [67, 13, 'Es lo mismo que oculten sus pensamientos o que los divulguen, Él conoce bien lo que hay dentro de los corazones.'],
  [67, 14, '¿Acaso no lo va a saber Quien todo lo creó? Él es el Sutil, el que está bien informado.'],
  ...
  [67, 17, '¿O se sienten seguros de que Quien está en el cielo no los azote con un viento fuerte? ¿Solo así tomarán en serio Mi advertencia?'],
  ...
  [67, 20, '¿Qué ejército los podría defender además del Misericordioso? Los que desmienten el Mensaje son presa de una ilusión.'],
  ...
  [67, 23, 'Diles: "Él es Quien los creó y Quien los agració con el oído, la vista y el intelecto. Sin embargo, qué poco agradecen".'],
  [67, 24, 'Diles: "Él es Quien hizo que se multiplicaran en la Tierra y ante Él comparecerán".'],
  [67, 25, '[Los que desmienten el Mensaje] dicen desafiantes: "¿Cuándo se cumplirá esta amenaza [sobre el Día del Juicio], si es que dicen la verdad?"'],
  [67, 26, 'Diles: "Solo Dios lo sabe, yo no soy sino un amonestador".'],
  ...
  [68, 7, 'Tu Señor sabe mejor que nadie quiénes se extravían de Su camino, así como sabe quiénes son los que siguen la guía.'],
  ...
  [68, 12, 'a quien se niega a hacer el bien, al transgresor, al pecador,'],
  ...
  [68, 29, 'Dijeron: "Glorificado sea nuestro Señor, fuimos injustos".'],
  [68, 30, 'Y comenzaron a recriminarse unos a otros.'],
  [68, 31, 'Dijeron: "¡Ay de nosotros! Nos comportamos con mucha arrogancia.'],
  ...
  [68, 34, 'El Señor agraciará a los piadosos con los Jardines de las Delicias.'],
  [68, 35, '¿Acaso iba a tratar por igual a quienes se someten a Dios y a los pecadores?'],
  [68, 36, '¿Qué les pasa? ¿Cómo juzgan así?'],
  [68, 37, '¿Acaso tienen un libro [revelado] al que consultan,'],
  [68, 38, 'en el que eligen lo que les conviene?'],
  [68, 39, '¿O creen tener Conmigo un pacto hasta el Día de la Resurrección que Me obligue a concederles lo que quieran?'],
  [68, 40, 'Pregúntales: "¿Quién es el garante de ese pacto?"'],
  ...
  [68, 45, 'Los toleraré por un tiempo, pero luego Mi castigo será severo.'],
  [68, 46, '¿Acaso les reclamas una retribución [a cambio de transmitirles el Mensaje], que se sienten agobiados?'],
  [68, 47, '¿Acaso conocen lo oculto [de la predestinación] y lo escriben?'],
  ...
  [68, 50, 'Pero su Señor lo había escogido para que fuera uno de los piadosos.'],
  ...
  [69, 15, 'entonces ocurrirá el suceso.'],
  ...
  [69, 40, 'que el Corán es la palabra recitada por un Mensajero noble.'],
  ...
  [69, 48, 'El Corán es un motivo de reflexión para los que tienen temor de Dios,'],
  ...
  [69, 52, '¡Glorifica el nombre de tu Señor, el Grandioso!'],
  ...
  [70, 6, 'porque ellos lo ven lejano [al Día del Juicio],'],
  [70, 7, 'pero Yo sé que está cercano.'],
  [70, 8, 'El día que el cielo parezca masas de minerales fundidos'],
  ...
  [70, 26, 'que creen en el Día del Juicio Final,'],
  [70, 27, 'que tienen temor del castigo de su Señor,'],
  [70, 28, 'siendo que nadie está a salvo del castigo de su Señor.'],
  [70, 29, 'Los que preservan su sexualidad'],
  [70, 30, 'al ámbito conyugal o lo que posee la diestra, ya que eso no es censurable.'],
  [70, 31, 'Quien traspase este límite, sepa que es un trasgresor.'],
  ...
  [70, 35, 'estos serán honrados con jardines del Paraíso.'],
  ...
  [70, 41, 'para sustituirlos por otros seres mejores que ellos, sin que nadie pueda impedírmelo.'],
  [70, 42, 'Déjalos que discutan y jueguen hasta que les llegue el día con que se les ha advertido.'],
  ...
  [71, 2, 'Dijo [Noé]: "¡Pueblo mío! Soy un amonestador que Dios les ha enviado para que les hable con claridad,'],
  ...
  [71, 19, 'Dios les ha extendido la Tierra'],
  ...
  [72, 7, 'Ellos pensaban, como piensan ustedes, que Dios no iba a resucitar a nadie [de su tumba].'],
  ...
  [72, 21, 'Diles: "No tengo poder personal para desviarlos ni para guiarlos por el camino recto".'],
  ...
  [72, 24, 'Y cuando vean lo que se les había prometido sabrán quiénes están realmente desamparados y quiénes son los insignificantes.'],
  ...
  [73, 10, 'Ten paciencia con lo que dicen [insultándote], pero apártate de ellos discretamente.'],
  ...
  [73, 19, 'Esto es una advertencia real; en consecuencia, quien quiera que emprenda un camino hacia su Señor.'],
  ...
  [74, 13, 'y numerosos hijos atentos.'],
  [74, 14, 'Y le facilité medios con holgura,'],
  ...
  [74, 23, 'Luego le dio la espalda [al Mensaje] y se comportó con soberbia,'],
  ...
  [74, 27, '¿Y qué te hará comprender lo que es el fuego del Infierno?'],
  [74, 28, '[Es un fuego que] no deja nada sin quemar ni cesa jamás.'],
  ...
  [74, 40, '[Ellos estarán] en jardines y se preguntarán unos a otros'],
  [74, 41, 'acerca de [la situación] de los criminales.'],
  [74, 42, 'Y les preguntarán: "¿Qué fue lo que los llevó al fuego del Infierno?"'],
  [74, 43, 'Ellos responderán: "Fue que no cumplíamos con la oración,'],
  [74, 44, 'no dábamos de comer al pobre,'],
  [74, 45, 'nos entreteníamos difamando [la revelación] junto a quienes retuercen la lógica para negar la verdad,'],
  ...
  [74, 49, '¿Qué les pasa que se apartan de la amonestación [del Corán]'],
  [74, 50, 'como si fueran cebras espantadas'],
  [74, 51, 'huyendo de un león?'],
  [74, 52, 'Ellos quisieran que descendieran [del cielo] páginas con un mensaje especial [que les confirmase que Mujámmad es un Mensajero de Dios].'],
  [74, 53, 'Pero no se lo concederemos, porque no tienen temor devocional a la vida del más allá.'],
  [74, 54, '[El Corán] es una exhortación'],
  ...
  [75, 12, 'Ese día, todos comparecerán ante tu Señor.'],
  ...
  [75, 28, 'El agonizante sabrá que llega el momento de partir [de este mundo],'],
  ...
  [75, 32, 'sino que desmentía [la verdad] y le daba la espalda'],
  ...
  [75, 39, 'Y creó de allí la pareja: el hombre y la mujer.'],
  ...
  [76, 27, 'Los que rechazan el Mensaje aman la vida efímera y dan la espalda a un día cargado de aflicción [en el que serán juzgados].'],
  ...
  [76, 29, 'Esta revelación es para reflexionar. Quien quiera, que tome un camino hacia su Señor.'],
  ...
  [77, 5, 'por los [Profetas] que transmiten Mensajes'],
  [77, 6, 'como aclaración o advertencia [para el Día del Juicio].'],
  [77, 7, 'Tengan certeza de que aquello con que se les advierte se cumplirá'],
  ...
  [77, 12, '¿Para qué día se los convocará?'],
  [77, 13, 'Para el Día del Juicio.'],
  [77, 14, '¿Y qué te hará comprender qué es el Día del Juicio?'],
  [77, 15, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  [77, 16, '¿Acaso no destruí otros pueblos antiguos [que rechazaron el Mensaje]?'],
  [77, 17, 'Luego les siguieron otros pueblos [de desmentidores].'],
  [77, 18, 'Eso es lo que sucede a los pecadores.'],
  [77, 19, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  [77, 20, '¿No los he creado de un líquido insignificante'],
  [77, 21, 'que deposité en un lugar seguro [el útero]'],
  [77, 22, 'por un tiempo determinado?'],
  [77, 23, 'Así lo he decretado, y Mi decreto es perfecto.'],
  [77, 24, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  ...
  [77, 28, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  ...
  [77, 34, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  [77, 35, 'Ese día no hablarán'],
  [77, 36, 'ni se les permitirá excusarse.'],
  [77, 37, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  [77, 38, 'Este es el día de la sentencia. Los he reunido a los primeros y a los últimos.'],
  [77, 39, 'Si creen tener alguna treta [para huir], úsenla ahora.'],
  [77, 40, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  [77, 41, 'Pero los que hayan tenido temor de Dios, estarán bajo sombras frescas entre manantiales.'],
  [77, 42, 'Tendrán las frutas que deseen.'],
  [77, 43, '[Se les dirá:] "Coman y beban cuanto quieran como recompensa por lo que obraron".'],
  [77, 44, 'Así recompensaré a los que hagan el bien.'],
  [77, 45, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  [77, 46, '[¡Aquellos que niegan el Mensaje!] Coman y disfruten temporalmente, porque están hundidos en el pecado.'],
  [77, 47, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  [77, 48, 'Cuando se les dice: "Hagan la oración", no la hacen.'],
  [77, 49, '¡Cuán desdichados serán ese día los que negaron la verdad!'],
  [77, 50, '¿En qué otro Mensaje fuera de este han de creer?'],
  ...
  [78, 6, '¿Acaso no hice de la tierra un lecho,'],
  [78, 7, 'de las montañas estacas,'],
  [78, 8, 'los cree en parejas [hombre y mujer],'],
  [78, 9, 'hice que el sueño sea descanso,'],
  [78, 10, 'que la noche lo cubra,'],
  [78, 11, 'que el día sea para procurar el sustento,'],
  [78, 12, 'construí sobre ustedes siete cielos firmes,'],
  ...
  [78, 17, 'El Día del Juicio Final ya está determinado.'],
  [78, 18, 'Ese día, se soplará la trompeta y ustedes se presentarán en grupos.'],
  [78, 19, 'El cielo será abierto, transformándose en un portal.'],
  [78, 20, 'Las montañas desaparecerán como si hubieran sido un espejismo.'],
  [78, 21, 'El Infierno estará al acecho,'],
  [78, 22, 'será la morada de los transgresores'],
  ...
  [78, 29, 'pero Yo lo registré todo en un libro.'],
  ...
  [79, 17, '[y le dijo:] "Ve ante el Faraón, pues se ha excedido,'],
  ...
  [79, 21, 'Pero el Faraón lo desmintió y rechazó seguirlo.'],
  [79, 22, 'Luego le dio la espalda y desobedeció [el Mensaje].'],
  [79, 23, 'Y convocó [a su pueblo] y les dijo:'],
  [79, 24, '"Yo soy su Señor supremo".'],
  [79, 25, 'Por eso Dios lo castigará en la otra vida, pero también en esta.'],
  [79, 26, 'En esta historia hay motivo de reflexión para quien tiene temor de Dios.'],
  ...
  [79, 33, 'Todo para beneficio de ustedes y de sus rebaños.'],
  [79, 34, 'El día que suceda la gran calamidad [el fin del mundo]'],
  [79, 35, 'el ser humano recordará todo lo que haya hecho,'],
  [79, 36, 'y será expuesto el fuego del Infierno para que lo vean.'],
  [79, 37, 'Quien se haya extralimitado'],
  [79, 38, 'y preferido la vida mundanal,'],
  [79, 39, 'su morada será el Infierno.'],
  [79, 40, 'En cambio, quien haya tenido conciencia de que comparecerá ante su Señor y haya preservado su alma de seguir sus pasiones,'],
  [79, 41, 'su morada será el Paraíso.'],
  [79, 42, 'Te preguntan cuándo será la hora del Juicio Final.'],
  [79, 43, 'Pero tú [¡oh, Mujámmad!] no tienes conocimiento de cuándo será.'],
  [79, 44, 'Solo tu Señor lo sabe.'],
  ...
  [80, 8, 'En cambio, aquel que se presentó ante ti con deseos [de aprender],'],
  [80, 9, 'teniendo temor de Dios,'],
  [80, 10, 'te apartaste de él.'],
  ...
  [80, 13, 'Pues el Mensaje está registrado en páginas honorables,'],
  ...
  [80, 22, 'Finalmente lo resucita cuando Él quiere.'],
  ...
  [80, 32, 'para beneficio de ustedes y de sus rebaños.'],
  [80, 33, 'El día que llegue el estruendo terrible [comenzando el fin del mundo],'],
  ...
  [80, 42, 'Esos serán los que rechazaron el Mensaje y los transgresores [de la ley].'],
  [81, 1, 'Cuando el Sol se contraiga [y oscurezca],'],
  [81, 2, 'cuando las estrellas pierdan su luz,'],
  [81, 3, 'cuando las montañas sean pulverizadas,'],
  ...
  [81, 12, 'cuando el fuego del Infierno sea avivado,'],
  [81, 13, 'y cuando el Paraíso sea acercado.'],
  [81, 14, 'En ese momento sabrá cada alma el resultado de sus obras.'],
  [81, 15, 'Juro por los astros '],
  [81, 16, 'que recorren sus órbitas,'],
  [81, 17, 'y [juro] por la noche cuando extiende su oscuridad,'],
  [81, 18, 'y [juro] por la mañana cuando extiende su luminosidad,'],
  [81, 19, 'que [el Corán] es la palabra [de Dios transmitida] por un emisario noble,'],
  [81, 20, 'dotado de poder y distinción ante el Señor del Trono.'],
  [81, 21, 'El obedecido [por otros ángeles] y el digno confidente [de la revelación].'],
  [81, 22, '[Sepan que] su compañero [el Profeta Mujámmad] no es un loco,'],
  [81, 23, 'lo vio [al ángel Gabriel] en el horizonte claro,'],
  [81, 24, 'no oculta nada de lo que le fue revelado.'],
  [81, 25, '[El Corán] no es la palabra de un demonio maldito.'],
  ...
  [81, 29, 'Pero sepan que solo se encaminará quien quiera Dios, Señor del universo.'],
  ...
  [82, 13, 'Los piadosos disfrutarán delicias [en esta vida y en el Paraíso],'],
  [82, 14, 'mientras que los pecadores, en cambio, sufrirán tormento [en esta vida y en la otra],'],
  [82, 15, 'y arderán en el Infierno desde el Día del Juicio,'],
  [82, 16, 'del que no podrán salir.'],
  [82, 17, '¿Qué te hará comprender todo lo que sucederá el Día de la Retribución?'],
  ...
  [83, 11, 'Los que desmintieron el Día del Juicio,'],
  [83, 12, 'pues solo lo desmienten los transgresores y los pecadores.'],
  [83, 13, 'Quienes, cuando les es recitada Mi palabra, dicen: "Son fábulas de los pueblos antiguos".'],
  ...
  [83, 16, 'Luego serán llevados al Infierno,'],
  [83, 17, 'donde se les dirá: "Esto es lo que desmentían y rechazaban".'],
  [83, 18, 'En cambio, el registro de los bienaventurados será un libro noble.'],
  [83, 19, '¿Y qué te hará saber lo que es un libro noble?'],
  [83, 20, 'Es el libro donde se registran las obras de los que hacen el bien,'],
  [83, 21, 'que puede ser visto por los [ángeles] cercanos [a Dios].'],
  [83, 22, 'Los bienaventurados gozarán las delicias del Paraíso,'],
  [83, 23, 'recostados en sofás, contemplando.'],
  ...
  [83, 29, 'Los que se abandonan al pecado se ríen [en esta vida] de los creyentes.'],
  [83, 30, 'Cuando pasan junto a ellos se hacen gestos [despectivos],'],
  [83, 31, 'y cuando regresan a sus hogares se jactan [de ello].'],
  [83, 32, 'Cuando ven a los suyos dicen: "Ellos son unos desviados",'],
  ...
  [84, 7, 'Quien reciba el registro de sus obras en su mano derecha'],
  [84, 8, 'tendrá un juicio fácil,'],
  [84, 9, 'y [una vez terminado] se reunirá jubiloso con su gente [en el Paraíso]. '],
  [84, 10, 'Mientras que quien reciba el registro de sus obras por detrás de su espalda,'],
  [84, 11, 'suplicará ser destruido definitivamente.'],
  [84, 12, 'Pero será arrastrado al castigo del Infierno.'],
  [84, 13, 'Él vivía alegre con su familia [despreocupado del más allá]'],
  [84, 14, 'pensando que jamás comparecería [ante Dios].'],
  [84, 15, 'Pero sí, su Señor estaba bien informado de lo que hacía.'],
  ...
  [84, 20, '¿Qué es lo que les impide creer?'],
  [84, 21, '¿Qué les impide prosternarse cuando se les recita el Corán?'],
  [84, 22, 'Los que rechazan la verdad se empeñan en desmentir [el Mensaje].'],
  ...
  [85, 11, 'En cambio, quienes hayan creído y obrado correctamente serán recompensados con jardines por donde corren los ríos. Ese es el triunfo grandioso.'],
  [85, 12, '¡Pero el castigo de tu Señor es severo!'],
  [85, 13, 'Él da origen y reproduce.'],
  [85, 14, 'Él es el Absolvedor, el Afectuoso.'],
  [85, 15, 'Señor del Trono, el Majestuoso.'],
  [85, 16, 'Hacedor de Su voluntad.'],
  ...
  [85, 19, 'Sin embargo, los que niegan la verdad continúan desmintiendo.'],
  [85, 20, 'Pero Dios los domina sin que lo sepan.'],
  [85, 21, 'Este es un Corán glorioso'],
  ...
  [86, 5, 'Que medite el hombre de qué fue creado:'],
  ...
  [86, 13, 'que el Corán es la Verdad que discrimina [la verdad de la falsedad], '],
  [86, 14, 'y no es algo trivial.'],
  [86, 15, '[Los que niegan la verdad] traman [cizañas],'],
  [86, 16, 'pero Yo desbarato sus planes.'],
  [86, 17, 'Sé tolerante con los que niegan la verdad, y dales un tiempo.'],
  [87, 1, 'Glorifica el nombre de tu Señor, el Altísimo,'],
  [87, 2, 'Quien creó todas las cosas a la perfección'],
  [87, 3, 'y decretó para cada ser su función;'],
  [87, 4, 'Quien hace brotar la hierba,'],
  ...
  [87, 8, 'Te dirigiré por el camino de la facilidad.'],
  ...
  [88, 7, 'que no alimentan ni sacian.'],
  [88, 8, 'Pero ese día los rostros [de los bienaventurados] estarán radiantes de felicidad.'],
  [88, 9, 'Estarán complacidos de sus obras.'],
  [88, 10, 'Morarán en un jardín sublime,'],
  [88, 11, 'en el que no oirán palabras vanas.'],
  [88, 12, 'En él habrá manantiales,'],
  [88, 13, 'lechos elevados,'],
  [88, 14, 'copas al alcance de su mano,'],
  ...
  [88, 18, 'En el cielo, cómo ha sido elevado.'],
  [88, 19, 'En las montañas, cómo han sido afirmadas.'],
  [88, 20, 'Y en la Tierra, cómo ha sido extendida.'],
  [88, 21, 'Exhorta a la gente porque esa es tu misión.'],
  ...
  [89, 11, 'Todos ellos fueron tiranos con los pueblos,'],
  ...
  [89, 15, 'El ser humano, cuando su Señor lo agracia, dice: "Mi Señor me ha honrado [porque lo merezco]".'],
  ...
  [89, 28, 'Vuelve a la vera de tu Señor complacida, porque Dios está complacido contigo,'],
  ...
  [90, 5, '¿Acaso piensa que nadie tiene poder sobre él?'],
  ...
  [90, 18, 'Estos son los bienaventurados de la derecha.'],
  [90, 19, 'Mientras que quienes rechacen Mi revelación serán los desventurados de la izquierda'],
  ...
  [91, 4, 'por la noche cuando cubre con su oscuridad,'],
  ...
  [92, 7, 'le facilitaré el camino del bien.'],
  ...
  [92, 13, 'y a Mí me pertenecen esta vida y la otra.'],
  ...
  [92, 17, 'Pero el piadoso estará a salvo [de ese fuego],'],
  [92, 18, 'aquel que da parte de su riqueza para purificarse [de la avaricia],'],
  ...
  [93, 6, '¿Acaso no te encontró huérfano y te dio amparo,'],
  ...
  [96, 2, 'Creó al hombre de una célula embrionaria.'],
  ...
  [96, 6, 'No obstante, el ser humano se excede'],
  ...
  [96, 11, '¿Acaso ha recapacitado que trae la guía'],
  [96, 12, 'y exhorta a la piedad?'],
  [96, 13, '¿Acaso no ves cómo desmiente y rechaza?'],
  [96, 14, '¿Acaso no sabe que Dios lo ve?'],
  [96, 15, 'Si no pone fin [a sus agresiones contra los creyentes] lo arrastraré por su frente,'],
  [96, 16, 'esa frente mentirosa y perversa.'],
  ...
  [99, 3, 'y el hombre diga: "¿Qué le sucede a la Tierra?"'],
  ...
  [100, 7, 'Y él mismo es testigo de ello,'],
  ...
  [100, 10, 'y se evidencie lo que hay en los corazones,'],
  [100, 11, 'ese día su Señor estará bien informado de lo que hicieron?'],
  [101, 1, 'El evento repentino.'],
  [101, 2, '¿Qué es el evento repentino?'],
  [101, 3, '¿Y qué te hará comprender la magnitud del evento repentino?'],
  ...
  [101, 10, '¿Y qué te hará comprender qué es el abismo?'],
  ...
  [102, 3, '¡No deberían comportarse así! Ya se van a enterar [que obrar para la otra vida es superior].'],
  ...
  [104, 5, '¿Y qué te hará comprender lo que es un fuego demoledor?'],
  [104, 6, 'Es un fuego encendido por Dios'],
  [104, 7, 'cuyo dolor alcanza los corazones.'],
  ...
  [113, 2, 'de todo el mal que existe en lo que Él creó,'],
  ...
  [114, 3, 'en el [único] Dios de los seres humanos,'],
